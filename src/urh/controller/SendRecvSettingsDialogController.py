...
class SendRecvSettingsDialogController(ProtocolSniffDialogController):
    ...
    def create_connects(self):
        ...
        self.ui.comboBoxChannel.currentIndexChanged.connect(self.on_rx_channel_changed)
        self.ui.comboBoxAntenna.currentIndexChanged.connect(self.on_rx_antenna_changed)
        self.ui.lineEditIP.textChanged.connect(self.on_rx_ip_changed)
        self.ui.spinBoxPort.valueChanged.connect(self.on_rx_port_changed)
        self.ui.spinBoxGain.valueChanged.connect(self.on_rx_rf_gain_changed)
        self.ui.spinBoxIFGain.valueChanged.connect(self.on_rx_if_gain_changed)
        self.ui.spinBoxBasebandGain.valueChanged.connect(self.on_rx_baseband_gain_changed)

        self.ui.comboBoxChannel_tx.currentIndexChanged.connect(self.on_tx_channel_changed)
        self.ui.comboBoxAntenna_tx.currentIndexChanged.connect(self.on_tx_antenna_changed)
        self.ui.lineEditIP_tx.textChanged.connect(self.on_tx_ip_changed)
        self.ui.spinBoxPort_tx.valueChanged.connect(self.on_tx_port_changed)
        self.ui.spinBoxGain_tx.valueChanged.connect(self.on_tx_rf_gain_changed)
        self.ui.spinBoxIFGain_tx.valueChanged.connect(self.on_tx_if_gain_changed)
        self.ui.spinBoxBasebandGain_tx.valueChanged.connect(self.on_tx_baseband_gain_changed)
