...
"}")
        ...
        self.gvSpectrogram.setViewportUpdateMode(QtWidgets.QGraphicsView.FullViewportUpdate)
        self.gvSpectrogram.setOptimizationFlags(QtWidgets.QGraphicsView.DontClipPainter)
        ...
        self.horizontalLayout_4.addWidget(self.graphicsViewColorbar)
