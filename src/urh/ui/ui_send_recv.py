...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 624, 1293))
...
"}")
        ...
        self.gridLayout_4.setContentsMargins(0, 15, 0, 0)
...
"}")
        ...
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.groupBoxDeviceSettings)
        ...
        self.gridLayout_5.setContentsMargins(15, 0, 0, 0)
        ...
        self.cbDevice.addItem("")
        self.gridLayout_5.addWidget(self.cbDevice, 0, 1, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.spinBoxPort, 5, 1, 1, 2)
        self.labelFreq = QtWidgets.QLabel(self.frame_2)
        self.labelFreq.setObjectName("labelFreq")
        self.gridLayout_5.addWidget(self.labelFreq, 6, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxFreq, 6, 1, 1, 2)
        self.labelSampleRate = QtWidgets.QLabel(self.frame_2)
        self.labelSampleRate.setObjectName("labelSampleRate")
        self.gridLayout_5.addWidget(self.labelSampleRate, 7, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxSampleRate, 7, 1, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.btnLockBWSR, 7, 3, 2, 1)
        self.labelBandwidth = QtWidgets.QLabel(self.frame_2)
        self.labelBandwidth.setObjectName("labelBandwidth")
        self.gridLayout_5.addWidget(self.labelBandwidth, 8, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxBandwidth, 8, 1, 1, 2)
        self.labelGain = QtWidgets.QLabel(self.frame_2)
        self.labelGain.setObjectName("labelGain")
        self.gridLayout_5.addWidget(self.labelGain, 9, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.sliderGain, 9, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxGain, 9, 2, 1, 1)
        self.labelIFGain = QtWidgets.QLabel(self.frame_2)
        self.labelIFGain.setObjectName("labelIFGain")
        self.gridLayout_5.addWidget(self.labelIFGain, 10, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.sliderIFGain, 10, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxIFGain, 10, 2, 1, 1)
        self.labelBasebandGain = QtWidgets.QLabel(self.frame_2)
        self.labelBasebandGain.setObjectName("labelBasebandGain")
        self.gridLayout_5.addWidget(self.labelBasebandGain, 11, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.sliderBasebandGain, 11, 1, 1, 1)
        self.labelFreqCorrection = QtWidgets.QLabel(self.frame_2)
        self.labelFreqCorrection.setObjectName("labelFreqCorrection")
        self.gridLayout_5.addWidget(self.labelFreqCorrection, 12, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxFreqCorrection, 12, 1, 1, 2)
        self.labelDirectSampling = QtWidgets.QLabel(self.frame_2)
        self.labelDirectSampling.setObjectName("labelDirectSampling")
        self.gridLayout_5.addWidget(self.labelDirectSampling, 13, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.comboBoxDirectSampling, 13, 1, 1, 2)
        self.labelNRepeat = QtWidgets.QLabel(self.frame_2)
        self.labelNRepeat.setObjectName("labelNRepeat")
        self.gridLayout_5.addWidget(self.labelNRepeat, 14, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.spinBoxNRepeat, 14, 1, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.spinBoxBasebandGain, 11, 2, 1, 1)
