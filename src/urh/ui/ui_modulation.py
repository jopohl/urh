...
class Ui_DialogModulation(object):
    def setupUi(self, DialogModulation):
        ...
        self.lPlus.setMinimumSize(QtCore.QSize(30, 30))
        ...
        self.doubleSpinBoxCarrierFreq.setDecimals(4)
        ...
        self.doubleSpinBoxCarrierPhase = QtWidgets.QDoubleSpinBox(DialogModulation)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.doubleSpinBoxCarrierPhase.setDecimals(4)
        ...
        self.linEdDataBits.setMinimumSize(QtCore.QSize(227, 0))
        ...
        self.spinBoxSampleRate.setDecimals(4)
        self.spinBoxSampleRate.setMinimum(0.0)
        ...
        self.spinBoxParameter1.setDecimals(4)
        self.spinBoxParameter1.setMinimum(0.0001)
        ...
        self.gridLayout_3.addWidget(self.chkBoxLockSIV, 5, 0, 1, 3)
        ...
        self.comboBoxModulationType.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.spinBoxParameter0.setDecimals(4)
        self.spinBoxParameter0.setMinimum(0.0001)
        ...
        self.gridLayout_3.addWidget(self.lSamplesInViewModulatedText, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lSamplesInViewModulated, 3, 1, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.lModulatedSelectedSamples, 4, 1, 1, 2)
        ...
        self.treeViewSignals.setMinimumSize(QtCore.QSize(0, 0))
        self.treeViewSignals.setMaximumSize(QtCore.QSize(16777215, 16777215))
        ...
        self.btnSearchPrev.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.lSlash.setMinimumSize(QtCore.QSize(7, 0))
        ...
        self.btnSearchNext.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.lSamplesInViewOrigSignal.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.lOriginalSignalSamplesSelected = QtWidgets.QLabel(DialogModulation)
        ...
        self.gVOriginalSignal.setMinimumSize(QtCore.QSize(0, 100))
        ...
        self.gVData.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.gVCarrier.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.lEqual.setMinimumSize(QtCore.QSize(30, 30))
    ...
    def retranslateUi(self, DialogModulation):
        ...
        self.comboBoxModulationType.setItemText(2, _translate("DialogModulation", "Phase Shift Keying (PSK)"))
