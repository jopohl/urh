...
class Ui_DialogMessageType(object):
    def setupUi(self, DialogMessageType):
        ...
        self.cbRulesetMode = QtWidgets.QComboBox(parent=DialogMessageType)
        ...
        self.tblViewRuleset = QtWidgets.QTableView(parent=DialogMessageType)
        ...
        self.btnRemoveRule = QtWidgets.QToolButton(parent=DialogMessageType)
        ...
        self.rbAssignManually = QtWidgets.QRadioButton(parent=DialogMessageType)
        self.rbAssignManually.setObjectName("rbAssignManually")
        self.gridLayout.addWidget(self.rbAssignManually, 0, 0, 1, 1)
        self.rbAssignAutomatically = QtWidgets.QRadioButton(parent=DialogMessageType)
        ...
        self.btnAddRule = QtWidgets.QToolButton(parent=DialogMessageType)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=DialogMessageType)
