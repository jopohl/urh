...
class Ui_DialogFilterBandwidth(object):
    def setupUi(self, DialogFilterBandwidth):
        ...
        self.radioButtonVeryWide = QtWidgets.QRadioButton(DialogFilterBandwidth)
        self.radioButtonVeryWide.setObjectName("radioButtonVeryWide")
        self.gridLayout.addWidget(self.radioButtonVeryWide, 6, 0, 1, 1)
        self.radioButtonVeryNarrow = QtWidgets.QRadioButton(DialogFilterBandwidth)
        self.radioButtonVeryNarrow.setObjectName("radioButtonVeryNarrow")
        self.gridLayout.addWidget(self.radioButtonVeryNarrow, 2, 0, 1, 1)
    ...
    def retranslateUi(self, DialogFilterBandwidth):
        ...
        self.radioButtonVeryWide.setText(_translate("DialogFilterBandwidth", "Very Wide"))
        self.radioButtonVeryNarrow.setText(_translate("DialogFilterBandwidth", "Very Narrow"))
