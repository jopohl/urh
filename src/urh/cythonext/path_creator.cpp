 ...
 */
    {
        ...
        /*try:*/ {
          ...
          if (__pyx_t_12 == 0) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel private(__pyx_t_4, __pyx_t_17, __pyx_t_19, __pyx_t_15, __pyx_t_18, __pyx_t_16) private(__pyx_filename, __pyx_lineno, __pyx_clineno) shared(__pyx_parallel_why, __pyx_parallel_exc_type, __pyx_parallel_exc_value, __pyx_parallel_exc_tb)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      #ifdef WITH_THREAD
                      ...
                      #endif /* _OPENMP */
                      #ifdef _OPENMP
                      #pragma omp for lastprivate(__pyx_v_j) lastprivate(__pyx_v_maximum) lastprivate(__pyx_v_index) firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_minimum) lastprivate(__pyx_v_tmp) lastprivate(__pyx_v_sample) lastprivate(__pyx_v_chunk_end) schedule(static)
                      #endif /* _OPENMP */
 ...
 */
                              ...
                              *((float *) ( /* dim=0 */ ((char *) (((float *) __pyx_v_values.data) + __pyx_t_18)) )) = __pyx_v_maximum;
                              ...
                              #endif /* _OPENMP */
                              {
                                  ...
                                  __pyx_parallel_temp4 = __pyx_v_minimum;
                                  __pyx_parallel_temp5 = __pyx_v_tmp;
                                  __pyx_parallel_temp6 = __pyx_v_sample;
                                  __pyx_parallel_temp7 = __pyx_v_chunk_end;
                              }
                              __pyx_L17:;
                              #ifdef _OPENMP
                      ...
                      #else
{
              ...
              if (__pyx_parallel_why) {
                ...
                __pyx_v_minimum = __pyx_parallel_temp4;
                __pyx_v_tmp = __pyx_parallel_temp5;
                __pyx_v_sample = __pyx_parallel_temp6;
                __pyx_v_chunk_end = __pyx_parallel_temp7;
