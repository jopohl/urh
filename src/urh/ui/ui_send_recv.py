...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.gridLayout_2.addWidget(self.lSamplesSentText, 15, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lTimeText, 9, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lSignalSizeText, 7, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lTime, 12, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.lSignalSize, 8, 0, 1, 2)
        self.lblRepeatText = QtWidgets.QLabel(self.groupBox)
        self.lblRepeatText.setObjectName("lblRepeatText")
        self.gridLayout_2.addWidget(self.lblRepeatText, 13, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lblCurrentRepeatValue, 14, 0, 1, 1)
        self.lRAMAvailText = QtWidgets.QLabel(self.groupBox)
        self.lRAMAvailText.setObjectName("lRAMAvailText")
        self.gridLayout_2.addWidget(self.lRAMAvailText, 3, 0, 1, 1)
        self.labelRAMAvail = QtWidgets.QLabel(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.labelRAMAvail.sizePolicy().hasHeightForWidth())
        self.labelRAMAvail.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.labelRAMAvail.setFont(font)
        self.labelRAMAvail.setAlignment(QtCore.Qt.AlignCenter)
        self.labelRAMAvail.setObjectName("labelRAMAvail")
        self.gridLayout_2.addWidget(self.labelRAMAvail, 4, 0, 1, 1)
    ...
    def retranslateUi(self, SendRecvDialog):
        ...
        self.lRAMAvailText.setText(_translate("SendRecvDialog", "RAM available (in MiB):"))
        self.labelRAMAvail.setText(_translate("SendRecvDialog", "10000"))
