...
"}")
    ...
    def retranslateUi(self, SignalFrame):
        SignalFrame.setWindowTitle(QtWidgets.QApplication.translate("SignalFrame", "Frame", None, -1))
        self.cbModulationType.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>Choose signals modulation:</p><ul><li>Amplitude Shift Keying (ASK)</li><li>Frequency Shift Keying (FSK)</li><li>Phase Shift Keying (PSK)</li></ul></body></html>", None, -1))
        self.cbModulationType.setItemText(0, QtWidgets.QApplication.translate("SignalFrame", "ASK", None, -1))
        self.cbModulationType.setItemText(1, QtWidgets.QApplication.translate("SignalFrame", "FSK", None, -1))
        self.cbModulationType.setItemText(2, QtWidgets.QApplication.translate("SignalFrame", "PSK", None, -1))
        self.btnAdvancedModulationSettings.setText(QtWidgets.QApplication.translate("SignalFrame", "...", None, -1))
        self.labelModulation.setText(QtWidgets.QApplication.translate("SignalFrame", "Modulation:", None, -1))
        self.chkBoxSyncSelection.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "If this is set to true, your selected protocol bits will show up in the signal view, and vice versa.", None, -1))
        self.chkBoxSyncSelection.setText(QtWidgets.QApplication.translate("SignalFrame", "Sync Selection", None, -1))
        self.spinBoxNoiseTreshold.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>Set the <span style=\" font-weight:600;\">noise magnitude</span> of your signal. You can tune this value to mute noise in your signal and reveal the true data.</p></body></html>", None, -1))
        self.chkBoxShowProtocol.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "Show the extracted protocol based on the parameters InfoLen, PauseLen and ZeroTreshold (in QuadratureDemod-View).\n"
"\n"
"If you want your protocol to be better seperated, edit the PauseLen using right-click menu from a selection in SignalView or ProtocolView.", None, -1))
        self.chkBoxShowProtocol.setText(QtWidgets.QApplication.translate("SignalFrame", "Show Signal as", None, -1))
        ...
        self.spinBoxTolerance.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>This is the error tolerance for determining the <span style=\" font-weight:600;\">pulse lengths</span> in the demodulated signal.</p><p><span style=\" font-weight:400; font-style:italic;\">Example:</span> Say, we are reading a ones pulse and the tolerance value was set to 5. Then 5 errors (which must follow sequentially) are accepted.</p><p>Tune this value if you have <span style=\" font-weight:600;\">spiky data</span> after demodulation.</p></body></html>", None, -1))
        self.lErrorTolerance.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>This is the error tolerance for determining the <span style=\" font-weight:600;\">pulse lengths</span> in the demodulated signal.</p><p><span style=\" font-weight:400; font-style:italic;\">Example:</span> Say, we are reading a ones pulse and the tolerance value was set to 5. Then 5 errors (which must follow sequentially) are accepted.</p><p>Tune this value if you have <span style=\" font-weight:600;\">spiky data</span> after demodulation.</p></body></html>", None, -1))
        self.lErrorTolerance.setText(QtWidgets.QApplication.translate("SignalFrame", "Error Tolerance:", None, -1))
        self.lSignalViewText.setText(QtWidgets.QApplication.translate("SignalFrame", "Signal View:", None, -1))
        self.lCenterOffset.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>This is the threshold used for determining if a <span style=\" font-weight:600;\">bit is one or zero</span>. You can set it here or grab the middle of the area in <span style=\" font-style:italic;\">Quadrature Demod View.</span></p></body></html>", None, -1))
        ...
        self.lSignalNr.setText(QtWidgets.QApplication.translate("SignalFrame", "1:", None, -1))
        self.btnInfo.setText(QtWidgets.QApplication.translate("SignalFrame", "...", None, -1))
        self.btnReplay.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "Replay signal", None, -1))
        self.labelFFTWindowSize.setText(QtWidgets.QApplication.translate("SignalFrame", "FFT Window Size:", None, -1))
        self.labelSpectrogramMin.setText(QtWidgets.QApplication.translate("SignalFrame", "Data<sub>min</sub>:", None, -1))
        self.labelSpectrogramMax.setText(QtWidgets.QApplication.translate("SignalFrame", "Data<sub>max</sub>:", None, -1))
        self.btnAutoDetect.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>Automatically detect <span style=\" font-weight:600;\">center</span>, <span style=\" font-weight:600;\">bit length</span> and <span style=\" font-weight:600;\">tolerance</span>. You can also choose to addtionally detect the <span style=\" font-weight:600;\">noise</span> and <span style=\" font-weight:600;\">modulation</span> when clicking this button.</p></body></html>", None, -1))
        self.btnAutoDetect.setText(QtWidgets.QApplication.translate("SignalFrame", "Autodetect parameters", None, -1))
        self.labelLoadingAutoInterpretation.setText(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>Running automatic detecting of demodulation parameters.</p><p>You can disable this behaviour for newly loaded signals by unchecking <span style=\" font-weight:600;\">Edit</span> -&gt; <span style=\" font-weight:600;\">Auto detect signals on loading</span>.</p></body></html>", None, -1))
        self.lYScale.setText(QtWidgets.QApplication.translate("SignalFrame", "Y-Scale", None, -1))
        self.btnShowHideStartEnd.setText(QtWidgets.QApplication.translate("SignalFrame", "-", None, -1))
        self.lNumSelectedSamples.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "Number of currently selected samples.", None, -1))
        self.lNumSelectedSamples.setText(QtWidgets.QApplication.translate("SignalFrame", "0", None, -1))
        self.lTextSelectedSamples.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "Number of currently selected samples.", None, -1))
        self.lTextSelectedSamples.setText(QtWidgets.QApplication.translate("SignalFrame", "selected", None, -1))
        self.lDuration.setText(QtWidgets.QApplication.translate("SignalFrame", "42 µs", None, -1))
        self.labelRSSI.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>This is the average signal power of the selection. The closer this value is to zero, the stronger the selected signal is.</p></body></html>", None, -1))
        self.labelRSSI.setText(QtWidgets.QApplication.translate("SignalFrame", "0,434 dBm", None, -1))
        self.btnFilter.setText(QtWidgets.QApplication.translate("SignalFrame", "Filter (moving average)", None, -1))
        self.lStart.setText(QtWidgets.QApplication.translate("SignalFrame", "Start:", None, -1))
        self.lEnd.setText(QtWidgets.QApplication.translate("SignalFrame", "End:", None, -1))
        self.lZoomText.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>Current (relative) Zoom. Standard is 100%, if you zoom in, this factor increases. You can directly set a value in the spinbox or use the <span style=\" font-weight:600;\">mousewheel to zoom</span>.</p></body></html>", None, -1))
        self.lZoomText.setText(QtWidgets.QApplication.translate("SignalFrame", "X-Zoom:", None, -1))
        self.spinBoxXZoom.setToolTip(QtWidgets.QApplication.translate("SignalFrame", "<html><head/><body><p>Current (relative) Zoom. Standard is 100%, if you zoom in, this factor increases. You can directly set a value in the spinbox or use the <span style=\" font-weight:600;\">mousewheel to zoom</span>.</p></body></html>", None, -1))
        self.spinBoxXZoom.setSuffix(QtWidgets.QApplication.translate("SignalFrame", "%", None, -1))
        self.lSamplesInView.setText(QtWidgets.QApplication.translate("SignalFrame", "0", None, -1))
        self.lStrich.setText(QtWidgets.QApplication.translate("SignalFrame", "/", None, -1))
