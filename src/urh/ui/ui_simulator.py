...
class Ui_SimulatorTab(object):
    def setupUi(self, SimulatorTab):
        ...
        self.scrollArea = QtWidgets.QScrollArea(parent=SimulatorTab)
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=self.splitterLeftRight)
        ...
        self.treeProtocols = GeneratorTreeView(parent=self.layoutWidget)
        ...
        self.listViewSimulate = QtWidgets.QListView(parent=self.layoutWidget)
        ...
        self.spinBoxRetries = QtWidgets.QSpinBox(parent=self.layoutWidget)
        ...
        self.btnStartSim = QtWidgets.QPushButton(parent=self.layoutWidget)
        ...
        self.cbViewType = QtWidgets.QComboBox(parent=self.tab_2)
        ...
        self.tableViewParticipants = ParticipantTableView(parent=self.tabParticipants)
        ...
        self.btnAddParticipant = QtWidgets.QToolButton(parent=self.tabParticipants)
        ...
        self.btnRemoveParticipant = QtWidgets.QToolButton(parent=self.tabParticipants)
        ...
        self.btnUp = QtWidgets.QToolButton(parent=self.tabParticipants)
        icon = QtGui.QIcon.fromTheme("go-up")
        self.btnUp.setIcon(icon)
        self.btnUp.setObjectName("btnUp")
        self.verticalLayout_9.addWidget(self.btnUp)
        self.btnDown = QtWidgets.QToolButton(parent=self.tabParticipants)
        ...
        self.lblMsgFieldsValues.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblMsgFieldsValues.setObjectName("lblMsgFieldsValues")
        self.verticalLayout_4.addWidget(self.lblMsgFieldsValues)
        self.detail_view_widget = QtWidgets.QStackedWidget(parent=self.layoutWidget_3)
        ...
        self.label_9 = QtWidgets.QLabel(parent=self.page_goto_action)
        ...
        self.tblViewFieldValues = SimulatorLabelTableView(parent=self.page_message)
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.page_message)
        self.label_2.setObjectName("label_2")
        self.gridLayout_6.addWidget(self.label_2, 0, 0, 1, 1)
        self.lblEncodingDecoding = QtWidgets.QLabel(parent=self.page_message)
        ...
        self.label_13 = QtWidgets.QLabel(parent=self.page_sleep)
        self.label_13.setObjectName("label_13")
        self.horizontalLayout_2.addWidget(self.label_13)
        self.doubleSpinBoxSleep = QtWidgets.QDoubleSpinBox(parent=self.page_sleep)
        ...
        self.spinBoxCounterStep = QtWidgets.QSpinBox(parent=self.page)
        ...
        self.spinBoxCounterStart = QtWidgets.QSpinBox(parent=self.page)
