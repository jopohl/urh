...
class Ui_DialogModulation(object):
    def setupUi(self, DialogModulation):
        ...
        DialogModulation.resize(1036, 1041)
        icon = QtGui.QIcon()
        ...
        self.btnRemoveModulation.setIcon(icon1)
        ...
        self.gridLayout_7.addItem(spacerItem2, 4, 3, 1, 1)
        ...
        self.gridLayout_7.addItem(spacerItem4, 7, 3, 1, 1)
        ...
        self.btnRestoreBits = QtWidgets.QToolButton(self.scrollAreaWidgetContents_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.btnRestoreBits.setIcon(icon1)
        ...
        self.lParameterfor0 = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBoxParameter0 = KillerDoubleSpinBox(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.spinBoxParameter0, 1, 1, 1, 1)
        self.lParameterfor1 = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.spinBoxParameter1 = KillerDoubleSpinBox(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.spinBoxParameter1, 2, 1, 1, 1)
        ...
        self.lSamplesInViewModulatedText = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lSamplesInViewModulated = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        ...
        self.gridLayout_3.addWidget(self.lSamplesInViewModulated, 5, 1, 1, 1)
        self.label_9 = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        self.label_9.setObjectName("label_9")
        self.gridLayout_3.addWidget(self.label_9, 6, 0, 1, 1)
        self.lModulatedSelectedSamples = QtWidgets.QLabel(self.scrollAreaWidgetContents_4)
        self.lModulatedSelectedSamples.setObjectName("lModulatedSelectedSamples")
        self.gridLayout_3.addWidget(self.lModulatedSelectedSamples, 6, 1, 1, 1)
        spacerItem8 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem8, 7, 0, 1, 1)
        ...
        self.btnSearchPrev.setIcon(icon1)
        ...
        self.btnSearchNext.setIcon(icon1)
        self.btnSearchNext.setObjectName("btnSearchNext")
        self.gridLayout_4.addWidget(self.btnSearchNext, 3, 5, 1, 1)
        self.lSamplesInViewOrigSignalText = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.lSamplesInViewOrigSignalText, 4, 0, 1, 2)
        self.lSamplesInViewOrigSignal = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_4.addWidget(self.lSamplesInViewOrigSignal, 4, 2, 1, 4)
        self.label_10 = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        self.label_10.setObjectName("label_10")
        self.gridLayout_4.addWidget(self.label_10, 5, 0, 1, 2)
        self.lOriginalSignalSamplesSelected = QtWidgets.QLabel(self.scrollAreaWidgetContents_5)
        self.lOriginalSignalSamplesSelected.setObjectName("lOriginalSignalSamplesSelected")
        self.gridLayout_4.addWidget(self.lOriginalSignalSamplesSelected, 5, 2, 1, 4)
        self.scrollArea_5.setWidget(self.scrollAreaWidgetContents_5)
        self.gridLayout_7.addWidget(self.scrollArea_5, 8, 0, 1, 1)
        ...
        DialogModulation.setTabOrder(self.scrollArea, self.gVCarrier)
    ...
    def retranslateUi(self, DialogModulation):
        DialogModulation.setWindowTitle(QtWidgets.QApplication.translate("DialogModulation", "Modulation", None, -1))
        self.comboBoxCustomModulations.setItemText(0, QtWidgets.QApplication.translate("DialogModulation", "My Modulation", None, -1))
        self.btnAddModulation.setText(QtWidgets.QApplication.translate("DialogModulation", "...", None, -1))
        self.btnRemoveModulation.setText(QtWidgets.QApplication.translate("DialogModulation", "...", None, -1))
        self.label_5.setText(QtWidgets.QApplication.translate("DialogModulation", "Data (raw bits)", None, -1))
        self.label_4.setText(QtWidgets.QApplication.translate("DialogModulation", "Carrier", None, -1))
        self.label_7.setText(QtWidgets.QApplication.translate("DialogModulation", "Original Signal (drag&drop)", None, -1))
        self.label_6.setText(QtWidgets.QApplication.translate("DialogModulation", "Modulation", None, -1))
        self.lCarrierFreq.setText(QtWidgets.QApplication.translate("DialogModulation", "Frequency:", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("DialogModulation", "Phase:", None, -1))
        self.doubleSpinBoxCarrierPhase.setSuffix(QtWidgets.QApplication.translate("DialogModulation", "°", None, -1))
        self.btnAutoDetect.setToolTip(QtWidgets.QApplication.translate("DialogModulation", "<html><head/><body><p>Auto detect the frequency based on the original signal. You have to select a signal (<span style=\" font-weight:600;\">bottom of this window</span>) to use this feature.</p><p><br/></p><p>Select a signal by dragging it from the tree and dropping it on the graphics pane to the right.</p></body></html>", None, -1))
        self.btnAutoDetect.setText(QtWidgets.QApplication.translate("DialogModulation", "Auto detect from original signal", None, -1))
        self.linEdDataBits.setPlaceholderText(QtWidgets.QApplication.translate("DialogModulation", "Enter Data Bits here", None, -1))
        ...
        self.lGaussWidth.setText(QtWidgets.QApplication.translate("DialogModulation", "Gauss filter width:", None, -1))
        self.lSamplesInViewModulatedText.setText(QtWidgets.QApplication.translate("DialogModulation", "Samples in View:", None, -1))
        self.lSamplesInViewModulated.setToolTip(QtWidgets.QApplication.translate("DialogModulation", "<html><head/><body><p>Shown Samples in View:</p><p><span style=\" font-weight:600; color:#ff0000;\">Red</span> - if samples in view differ from original signal</p><p><span style=\" font-weight:600;\">Normal</span> - if samples in view are equal to the original signal</p></body></html>", None, -1))
        self.lSamplesInViewModulated.setText(QtWidgets.QApplication.translate("DialogModulation", "101010121", None, -1))
        self.label_9.setText(QtWidgets.QApplication.translate("DialogModulation", "Samples selected:", None, -1))
        self.lModulatedSelectedSamples.setText(QtWidgets.QApplication.translate("DialogModulation", "0", None, -1))
        self.chkBoxLockSIV.setText(QtWidgets.QApplication.translate("DialogModulation", "Lock view to original signal", None, -1))
        self.cbShowDataBitsOnly.setText(QtWidgets.QApplication.translate("DialogModulation", "Show Only Data Sequence\n"
"(10)", None, -1))
        self.lCurrentSearchResult.setText(QtWidgets.QApplication.translate("DialogModulation", "-", None, -1))
        self.lSlash.setText(QtWidgets.QApplication.translate("DialogModulation", "/", None, -1))
        self.lTotalSearchresults.setText(QtWidgets.QApplication.translate("DialogModulation", "-", None, -1))
        self.lSamplesInViewOrigSignalText.setText(QtWidgets.QApplication.translate("DialogModulation", "Samples in View:", None, -1))
        self.lSamplesInViewOrigSignal.setToolTip(QtWidgets.QApplication.translate("DialogModulation", "<html><head/><body><p>Shown Samples in View:</p><p><span style=\" font-weight:600; color:#ff0000;\">Red</span> - if samples in view differ from original signal</p><p><span style=\" font-weight:600;\">Normal</span> - if samples in view are equal to the original signal</p></body></html>", None, -1))
        self.lSamplesInViewOrigSignal.setText(QtWidgets.QApplication.translate("DialogModulation", "0", None, -1))
