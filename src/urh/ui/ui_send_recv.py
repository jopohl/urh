...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.comboBoxProfiles = QtWidgets.QComboBox(SendRecvDialog)
        ...
        self.horizontalLayout_3.addWidget(self.comboBoxProfiles)
        self.btnAddProfile = QtWidgets.QToolButton(SendRecvDialog)
        icon = QtGui.QIcon.fromTheme("list-add")
        self.btnAddProfile.setIcon(icon)
        self.btnAddProfile.setObjectName("btnAddProfile")
        self.horizontalLayout_3.addWidget(self.btnAddProfile)
        self.btnRemoveProfile = QtWidgets.QToolButton(SendRecvDialog)
        icon = QtGui.QIcon.fromTheme("list-remove")
        self.btnRemoveProfile.setIcon(icon)
        self.btnRemoveProfile.setObjectName("btnRemoveProfile")
        self.horizontalLayout_3.addWidget(self.btnRemoveProfile)
...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -837, 404, 1574))
        ...
        self.gridLayout.addWidget(self.txtEditErrors, 27, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.groupBox, 26, 0, 1, 2)
        ...
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.tab_receive)
        self.verticalLayout_7.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.scrollArea_2 = QtWidgets.QScrollArea(self.tab_receive)
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.scrollAreaContents_rx = QtWidgets.QWidget()
        self.scrollAreaContents_rx.setGeometry(QtCore.QRect(0, 0, 368, 67))
        ...
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.tab_send)
        self.verticalLayout_8.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.scrollArea_3 = QtWidgets.QScrollArea(self.tab_send)
        self.scrollArea_3.setWidgetResizable(True)
        self.scrollArea_3.setObjectName("scrollArea_3")
        self.scrollAreaContents_tx = QtWidgets.QWidget()
        self.scrollAreaContents_tx.setGeometry(QtCore.QRect(0, -318, 405, 454))
        ...
        self.comboBoxChannel_tx = QtWidgets.QComboBox(self.scrollAreaContents_tx)
        self.comboBoxChannel_tx.setObjectName("comboBoxChannel_tx")
        self.gridLayout_3.addWidget(self.comboBoxChannel_tx, 0, 1, 1, 1)
        self.sliderGain_tx = QtWidgets.QSlider(self.scrollAreaContents_tx)
        self.sliderGain_tx.setMaximum(100)
        self.sliderGain_tx.setSingleStep(1)
        self.sliderGain_tx.setOrientation(QtCore.Qt.Horizontal)
        self.sliderGain_tx.setObjectName("sliderGain_tx")
        self.gridLayout_3.addWidget(self.sliderGain_tx, 4, 1, 1, 1)
        self.spinBoxIFGain_tx = QtWidgets.QSpinBox(self.scrollAreaContents_tx)
        self.spinBoxIFGain_tx.setObjectName("spinBoxIFGain_tx")
        self.gridLayout_3.addWidget(self.spinBoxIFGain_tx, 5, 2, 1, 1)
        self.sliderIFGain_tx = QtWidgets.QSlider(self.scrollAreaContents_tx)
        self.sliderIFGain_tx.setOrientation(QtCore.Qt.Horizontal)
        self.sliderIFGain_tx.setObjectName("sliderIFGain_tx")
        self.gridLayout_3.addWidget(self.sliderIFGain_tx, 5, 1, 1, 1)
        self.labelAntenna_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelAntenna_tx.setObjectName("labelAntenna_tx")
        self.gridLayout_3.addWidget(self.labelAntenna_tx, 1, 0, 1, 1)
        self.labelIP_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelIP_tx.setObjectName("labelIP_tx")
        self.gridLayout_3.addWidget(self.labelIP_tx, 2, 0, 1, 1)
        self.spinBoxGain_tx = QtWidgets.QSpinBox(self.scrollAreaContents_tx)
        self.spinBoxGain_tx.setMinimum(0)
        self.spinBoxGain_tx.setMaximum(99)
        self.spinBoxGain_tx.setProperty("value", 40)
        self.spinBoxGain_tx.setObjectName("spinBoxGain_tx")
        self.gridLayout_3.addWidget(self.spinBoxGain_tx, 4, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.btnEditModulation, 7, 2, 1, 1)
        self.lineEditIP_tx = QtWidgets.QLineEdit(self.scrollAreaContents_tx)
        self.lineEditIP_tx.setObjectName("lineEditIP_tx")
        self.gridLayout_3.addWidget(self.lineEditIP_tx, 2, 1, 1, 1)
        self.spinBoxPort_tx = QtWidgets.QSpinBox(self.scrollAreaContents_tx)
        self.spinBoxPort_tx.setMinimum(1)
        self.spinBoxPort_tx.setMaximum(65535)
        self.spinBoxPort_tx.setProperty("value", 1234)
        self.spinBoxPort_tx.setObjectName("spinBoxPort_tx")
        self.gridLayout_3.addWidget(self.spinBoxPort_tx, 3, 1, 1, 1)
        self.sliderBasebandGain_tx = QtWidgets.QSlider(self.scrollAreaContents_tx)
        self.sliderBasebandGain_tx.setSliderPosition(0)
        self.sliderBasebandGain_tx.setOrientation(QtCore.Qt.Horizontal)
        self.sliderBasebandGain_tx.setInvertedAppearance(False)
        self.sliderBasebandGain_tx.setInvertedControls(False)
        self.sliderBasebandGain_tx.setTickPosition(QtWidgets.QSlider.NoTicks)
        self.sliderBasebandGain_tx.setTickInterval(0)
        self.sliderBasebandGain_tx.setObjectName("sliderBasebandGain_tx")
        self.gridLayout_3.addWidget(self.sliderBasebandGain_tx, 6, 1, 1, 1)
        self.cBoxModulations = QtWidgets.QComboBox(self.scrollAreaContents_tx)
        self.cBoxModulations.setObjectName("cBoxModulations")
        self.cBoxModulations.addItem("")
        self.gridLayout_3.addWidget(self.cBoxModulations, 7, 1, 1, 1)
        self.lModulation = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lModulation.setObjectName("lModulation")
        self.gridLayout_3.addWidget(self.lModulation, 7, 0, 1, 1)
        self.labelBasebandGain_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelBasebandGain_tx.setObjectName("labelBasebandGain_tx")
        self.gridLayout_3.addWidget(self.labelBasebandGain_tx, 6, 0, 1, 1)
        self.labelPort_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelPort_tx.setObjectName("labelPort_tx")
        self.gridLayout_3.addWidget(self.labelPort_tx, 3, 0, 1, 1)
        self.labelChannel_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelChannel_tx.setObjectName("labelChannel_tx")
        self.gridLayout_3.addWidget(self.labelChannel_tx, 0, 0, 1, 1)
        self.modulationLayout_2 = QtWidgets.QGridLayout()
        self.modulationLayout_2.setObjectName("modulationLayout_2")
        self.lSampleRate = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lSampleRate.setObjectName("lSampleRate")
        self.modulationLayout_2.addWidget(self.lSampleRate, 0, 0, 1, 1)
        self.lModTypeValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lModTypeValue.setObjectName("lModTypeValue")
        self.modulationLayout_2.addWidget(self.lModTypeValue, 1, 1, 1, 1)
        self.lModType = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lModType.setObjectName("lModType")
        self.modulationLayout_2.addWidget(self.lModType, 1, 0, 1, 1)
        self.lBitLength = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lBitLength.setObjectName("lBitLength")
        self.modulationLayout_2.addWidget(self.lBitLength, 0, 2, 1, 1)
        self.lCarrierFrequency = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lCarrierFrequency.setObjectName("lCarrierFrequency")
        self.modulationLayout_2.addWidget(self.lCarrierFrequency, 3, 0, 1, 1)
        self.lSampleRateValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lSampleRateValue.setObjectName("lSampleRateValue")
        self.modulationLayout_2.addWidget(self.lSampleRateValue, 0, 1, 1, 1)
        self.lCarrierFreqValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lCarrierFreqValue.setObjectName("lCarrierFreqValue")
        self.modulationLayout_2.addWidget(self.lCarrierFreqValue, 3, 1, 1, 1)
        self.label_carrier_phase = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.label_carrier_phase.setObjectName("label_carrier_phase")
        self.modulationLayout_2.addWidget(self.label_carrier_phase, 5, 0, 1, 1)
        self.lCarrierPhaseValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lCarrierPhaseValue.setObjectName("lCarrierPhaseValue")
        self.modulationLayout_2.addWidget(self.lCarrierPhaseValue, 5, 1, 1, 1)
        self.lBitLenValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lBitLenValue.setObjectName("lBitLenValue")
        self.modulationLayout_2.addWidget(self.lBitLenValue, 0, 3, 1, 1)
        self.lParamForZero = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lParamForZero.setObjectName("lParamForZero")
        self.modulationLayout_2.addWidget(self.lParamForZero, 1, 2, 1, 1)
        self.lParamForZeroValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lParamForZeroValue.setObjectName("lParamForZeroValue")
        self.modulationLayout_2.addWidget(self.lParamForZeroValue, 1, 3, 1, 1)
        self.lParamForOne = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lParamForOne.setObjectName("lParamForOne")
        self.modulationLayout_2.addWidget(self.lParamForOne, 3, 2, 1, 1)
        self.lParamForOneValue = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.lParamForOneValue.setObjectName("lParamForOneValue")
        self.modulationLayout_2.addWidget(self.lParamForOneValue, 3, 3, 1, 1)
        self.gridLayout_3.addLayout(self.modulationLayout_2, 8, 0, 1, 3)
        self.spinBoxBasebandGain_tx = QtWidgets.QSpinBox(self.scrollAreaContents_tx)
        self.spinBoxBasebandGain_tx.setObjectName("spinBoxBasebandGain_tx")
        self.gridLayout_3.addWidget(self.spinBoxBasebandGain_tx, 6, 2, 1, 1)
        self.labelIFGain_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelIFGain_tx.setObjectName("labelIFGain_tx")
        self.gridLayout_3.addWidget(self.labelIFGain_tx, 5, 0, 1, 1)
        self.labelGain_tx = QtWidgets.QLabel(self.scrollAreaContents_tx)
        self.labelGain_tx.setObjectName("labelGain_tx")
        self.gridLayout_3.addWidget(self.labelGain_tx, 4, 0, 1, 1)
        self.comboBoxAntenna_tx = QtWidgets.QComboBox(self.scrollAreaContents_tx)
        self.comboBoxAntenna_tx.setObjectName("comboBoxAntenna_tx")
        self.gridLayout_3.addWidget(self.comboBoxAntenna_tx, 1, 1, 1, 1)
        spacerItem3 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_3.addItem(spacerItem3, 9, 0, 1, 1)
        self.scrollArea_3.setWidget(self.scrollAreaContents_tx)
        self.verticalLayout_8.addWidget(self.scrollArea_3)
        self.tabWidget.addTab(self.tab_send, "")
        self.gridLayout.addWidget(self.tabWidget, 25, 0, 1, 3)
    ...
    def retranslateUi(self, SendRecvDialog):
        ...
        self.btnAddProfile.setText(_translate("SendRecvDialog", "..."))
        self.btnRemoveProfile.setText(_translate("SendRecvDialog", "..."))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_receive), _translate("SendRecvDialog", "Receive"))
        self.sliderGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The gain (more exactly RF gain) is the gain applied to the RF signal. This amplifies the high frequent signal arriving at the antenna of your Software Defined Radio.</p></body></html>"))
        self.spinBoxIFGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The IF Gain is applied to the Intermediate Frequency signal in your Software Defined Radio. An IF signal has a lower frequency than the high frequent RF signal, so signal processing can be applied more efficiently.</p></body></html>"))
        self.sliderIFGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The IF Gain is applied to the Intermediate Frequency signal in your Software Defined Radio. An IF signal has a lower frequency than the high frequent RF signal, so signal processing can be applied more efficiently.</p></body></html>"))
        self.labelAntenna_tx.setText(_translate("SendRecvDialog", "Antenna:"))
        self.labelIP_tx.setText(_translate("SendRecvDialog", "IP address:"))
        self.spinBoxGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The gain (more exactly RF gain) is the gain applied to the RF signal. This amplifies the high frequent signal arriving at the antenna of your Software Defined Radio.</p></body></html>"))
        self.btnEditModulation.setText(_translate("SendRecvDialog", "Edit ..."))
        self.lineEditIP_tx.setText(_translate("SendRecvDialog", "127.0.0.1"))
        self.sliderBasebandGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The baseband gain is applied to the baseband signal in your software defined radio. The baseband signal is at low frequency and gathered from the RF signal by <span style=\" font-weight:600;\">complex downsampling</span>.</p></body></html>"))
        self.cBoxModulations.setItemText(0, _translate("SendRecvDialog", "MyModulation"))
        self.lModulation.setText(_translate("SendRecvDialog", "Configure modulation:"))
        self.labelBasebandGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The baseband gain is applied to the baseband signal in your software defined radio. The baseband signal is at low frequency and gathered from the RF signal by <span style=\" font-weight:600;\">complex downsampling</span>.</p></body></html>"))
        self.labelBasebandGain_tx.setText(_translate("SendRecvDialog", "Baseband gain:"))
        self.labelPort_tx.setText(_translate("SendRecvDialog", "Port number:"))
        self.labelChannel_tx.setText(_translate("SendRecvDialog", "Channel:"))
        self.lSampleRate.setText(_translate("SendRecvDialog", "Sample Rate:"))
        self.lModTypeValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.lModType.setText(_translate("SendRecvDialog", "Modulation Type:"))
        self.lBitLength.setText(_translate("SendRecvDialog", "Bit Length:"))
        self.lCarrierFrequency.setText(_translate("SendRecvDialog", "Carrier Frequency:"))
        self.lSampleRateValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.lCarrierFreqValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.label_carrier_phase.setText(_translate("SendRecvDialog", "Carrier Phase:"))
        self.lCarrierPhaseValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.lBitLenValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.lParamForZero.setText(_translate("SendRecvDialog", "Amplitude for 0:"))
        self.lParamForZeroValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.lParamForOne.setText(_translate("SendRecvDialog", "Amplitude for 1:"))
        self.lParamForOneValue.setText(_translate("SendRecvDialog", "TextLabel"))
        self.spinBoxBasebandGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The baseband gain is applied to the baseband signal in your software defined radio. The baseband signal is at low frequency and gathered from the RF signal by <span style=\" font-weight:600;\">complex downsampling</span>.</p></body></html>"))
        self.labelIFGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The IF Gain is applied to the Intermediate Frequency signal in your Software Defined Radio. An IF signal has a lower frequency than the high frequent RF signal, so signal processing can be applied more efficiently.</p></body></html>"))
        self.labelIFGain_tx.setText(_translate("SendRecvDialog", "IF Gain:"))
        self.labelGain_tx.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>The gain (more exactly RF gain) is the gain applied to the RF signal. This amplifies the high frequent signal arriving at the antenna of your Software Defined Radio.</p></body></html>"))
        self.labelGain_tx.setText(_translate("SendRecvDialog", "Gain:"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_send), _translate("SendRecvDialog", "Send"))
