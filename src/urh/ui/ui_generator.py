...
class Ui_GeneratorTab(object):
    def setupUi(self, GeneratorTab):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 599, 530))
        ...
        self.gridLayout.addWidget(self.tableMessages, 1, 0, 1, 7)
        ...
        self.gridLayout.addWidget(self.lEstimatedTime, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_3, 0, 0, 1, 7)
        ...
        self.gridLayout.addWidget(self.btnNetworkSDRSend, 2, 3, 1, 1)
