...
"}")
    ...
    def retranslateUi(self, GeneratorTab):
        GeneratorTab.setWindowTitle(QtWidgets.QApplication.translate("GeneratorTab", "Form", None, -1))
        self.treeProtocols.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p>Drag&amp;Drop Protocols to the table on the right to fill the generation table.</p></body></html>", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_proto), QtWidgets.QApplication.translate("GeneratorTab", "Protocols", None, -1))
        self.lWPauses.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p>The pauses will be added automatically when you drag a protocol from the tree above to the table on the right.<br/></p><p>You can see the <span style=\" font-weight:600;\">position</span> of each pause by <span style=\" font-weight:600;\">selecting it</span>. There will be drawn a line in the table indiciating the position of the pause.<br/></p><p>Use context menu or double click to <span style=\" font-weight:600;\">edit a pauses\' length</span>.</p></body></html>", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_pauses), QtWidgets.QApplication.translate("GeneratorTab", "Pauses", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("GeneratorTab", "Add fuzzing values to generated data", None, -1))
        self.btnFuzz.setText(QtWidgets.QApplication.translate("GeneratorTab", "Fuzz", None, -1))
        self.rBSuccessive.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p>For multiple labels per message the fuzzed values are inserted <span style=\" font-weight:600;\">one-by-one</span>.</p></body></html>", None, -1))
        self.rBSuccessive.setText(QtWidgets.QApplication.translate("GeneratorTab", "S&uccessive", None, -1))
        self.rbConcurrent.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p>For multiple labels per message the labels are fuzzed <span style=\" font-weight:600;\">at the same time</span>.</p></body></html>", None, -1))
        self.rbConcurrent.setText(QtWidgets.QApplication.translate("GeneratorTab", "&Concurrent", None, -1))
        self.rBExhaustive.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p>For multiple labels per message the fuzzed values are inserted in <span style=\" font-weight:600;\">all possible combinations</span>.</p></body></html>", None, -1))
        self.rBExhaustive.setText(QtWidgets.QApplication.translate("GeneratorTab", "E&xhaustive", None, -1))
        self.progressBarFuzzing.setFormat(QtWidgets.QApplication.translate("GeneratorTab", "%v/%m", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_fuzzing), QtWidgets.QApplication.translate("GeneratorTab", "Fuzzing", None, -1))
        self.cBoxModulations.setItemText(0, QtWidgets.QApplication.translate("GeneratorTab", "MyModulation", None, -1))
        self.lCarrierFreqValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.lModType.setText(QtWidgets.QApplication.translate("GeneratorTab", "Modulation Type:", None, -1))
        self.lModTypeValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.label_carrier_phase.setText(QtWidgets.QApplication.translate("GeneratorTab", "Carrier Phase:", None, -1))
        self.lCarrierPhaseValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.lParamForZero.setText(QtWidgets.QApplication.translate("GeneratorTab", "Amplitude for 0:", None, -1))
        self.lParamForZeroValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.lBitLength.setText(QtWidgets.QApplication.translate("GeneratorTab", "Bit Length:", None, -1))
        self.lBitLenValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.lParamForOne.setText(QtWidgets.QApplication.translate("GeneratorTab", "Amplitude for 1:", None, -1))
        self.lParamForOneValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.lEncoding.setText(QtWidgets.QApplication.translate("GeneratorTab", "Encoding:", None, -1))
        self.lEncodingValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "-", None, -1))
        self.lSampleRate.setText(QtWidgets.QApplication.translate("GeneratorTab", "Sample Rate:", None, -1))
        self.lSampleRateValue.setText(QtWidgets.QApplication.translate("GeneratorTab", "TextLabel", None, -1))
        self.lCarrierFrequency.setText(QtWidgets.QApplication.translate("GeneratorTab", "Carrier Frequency:", None, -1))
        self.lModulation.setText(QtWidgets.QApplication.translate("GeneratorTab", "Modulation:", None, -1))
        self.btnSend.setText(QtWidgets.QApplication.translate("GeneratorTab", "Send data...", None, -1))
        self.btnEditModulation.setText(QtWidgets.QApplication.translate("GeneratorTab", "Edit ...", None, -1))
        ...
        self.btnSave.setText(QtWidgets.QApplication.translate("GeneratorTab", "...", None, -1))
        self.btnOpen.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "Load a fuzz profile.", None, -1))
        self.btnOpen.setText(QtWidgets.QApplication.translate("GeneratorTab", "...", None, -1))
        self.btnNetworkSDRSend.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p><span style=\" font-weight:600;\">Send encoded data to your external application via TCP.</span></p></body></html>", None, -1))
        self.btnNetworkSDRSend.setText(QtWidgets.QApplication.translate("GeneratorTab", "Send via Network", None, -1))
        self.btnRfCatSend.setToolTip(QtWidgets.QApplication.translate("GeneratorTab", "<html><head/><body><p><span style=\" font-weight:600;\">Send encoded data via RfCat. </span></p><p><span style=\" font-style:italic;\">Hit again for stopping the sending process. Note that you can set the number of repetitions (from 1 to infinite) in:</span></p><p><span style=\" font-style:italic;\">Edit-&gt;Options-&gt;Device-&gt;\'Device sending repetitions\'</span></p></body></html>", None, -1))
        self.btnRfCatSend.setText(QtWidgets.QApplication.translate("GeneratorTab", "Send via RfCat", None, -1))
