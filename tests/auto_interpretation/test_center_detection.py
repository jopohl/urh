...
class TestCenterDetection(unittest.TestCase):
    ...
    def test_noisy_rect(self):
        data = IQSignal(get_path_for_data_file("fsk.complex")).iq_array.data
    ...
    def test_ask_center_detection(self):
        data = IQSignal(get_path_for_data_file("ask.complex")).iq_array.data
    ...
    def test_enocean_center_detection(self):
        data = IQSignal(get_path_for_data_file("enocean.complex")).iq_array.data
    ...
    def test_ask_50_center_detection(self):
        ...
        data = IQSignal(get_path_for_data_file("ask50.complex")).iq_array.data
    ...
    def test_homematic_center_detection(self):
        data = IQSignal(get_path_for_data_file("homematic.coco"), "").iq_array.data
    ...
    def test_noised_homematic_center_detection(self):
        data = IQSignal(get_path_for_data_file("noised_homematic.complex"), "").iq_array.data
    ...
    def test_fsk_10db_center_detection(self):
        data = IQSignal(get_path_for_data_file("FSK10.complex"), "").iq_array.data
        rect = afp_demod(data, 0, 1)
        center = detect_center(rect)
    ...
    def test_fsk_live_capture(self):
        data = IQSignal(get_path_for_data_file("fsk_live.coco"), "").iq_array.data
