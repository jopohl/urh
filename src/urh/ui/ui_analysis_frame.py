...
class Ui_FAnalysis(object):
    def setupUi(self, FAnalysis):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 885, 718))
        ...
        self.btnSaveProto = QtWidgets.QToolButton(self.frame_4)
        ...
        self.treeViewProtocols = ProtocolTreeView(self.frame_4)
        ...
        self.listViewParticipants = QtWidgets.QListView(self.frame_4)
        ...
        self.labelDecodingState = QtWidgets.QLabel(self.frame_4)
