...
class Ui_DialogSimulator(object):
    ...
    def retranslateUi(self, DialogSimulator):
        ...
        self.tabWidgetSimulatorSettings.setTabText(self.tabWidgetSimulatorSettings.indexOf(self.tabRX), _translate("DialogSimulator", "Receiving"))
        self.tabWidgetSimulatorSettings.setTabText(self.tabWidgetSimulatorSettings.indexOf(self.tabTX), _translate("DialogSimulator", "Transmitting"))
