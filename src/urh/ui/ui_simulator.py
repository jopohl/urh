...
class Ui_SimulatorTab(object):
    ...
    def retranslateUi(self, SimulatorTab):
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab), _translate("SimulatorTab", "Flow Graph"))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_2), _translate("SimulatorTab", "Messages"))
