...
class Ui_SignalFrame(object):
    def setupUi(self, SignalFrame):
        ...
        self.gridLayout_2.addWidget(self.chkBoxSyncSelection, 20, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.chkBoxShowProtocol, 19, 0, 1, 1)
        ...
        self.cbProtoView.addItem("")
        self.cbProtoView.addItem("")
        self.gridLayout_2.addWidget(self.cbProtoView, 19, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.labelFFTWindowSize, 17, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sliderFFTWindowSize, 17, 1, 1, 1)
        self.labelSpectrogramLOD = QtWidgets.QLabel(SignalFrame)
        self.labelSpectrogramLOD.setObjectName("labelSpectrogramLOD")
        self.gridLayout_2.addWidget(self.labelSpectrogramLOD, 18, 0, 1, 1)
        self.sliderSpectrogramLOD = QtWidgets.QSlider(SignalFrame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sliderSpectrogramLOD.sizePolicy().hasHeightForWidth())
        self.sliderSpectrogramLOD.setSizePolicy(sizePolicy)
        self.sliderSpectrogramLOD.setMinimum(1)
        self.sliderSpectrogramLOD.setOrientation(QtCore.Qt.Horizontal)
        self.sliderSpectrogramLOD.setObjectName("sliderSpectrogramLOD")
        self.gridLayout_2.addWidget(self.sliderSpectrogramLOD, 18, 1, 1, 1)
...
"If you want your protocol to be better seperated, edit the PauseLen using right-click menu from a selection in SignalView or ProtocolView."))
        ...
        self.labelSpectrogramLOD.setToolTip(_translate("SignalFrame", "<html><head/><body><p>Define the level of detail for spectrogram. A higher level of detail will give you a higher resolution, but it may take some seconds to calculate the more accurate spectrogram.</p></body></html>"))
        self.labelSpectrogramLOD.setText(_translate("SignalFrame", "Level of Detail:"))
        self.sliderSpectrogramLOD.setToolTip(_translate("SignalFrame", "Define the level of detail for spectrogram. A higher level of detail will give you a higher resolution, but it may take some seconds to calculate the more accurate spectrogram."))
