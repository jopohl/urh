...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 391, 1064))
        ...
        self.gridLayout.addWidget(self.lineEditIP, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxFreq, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxSampleRate, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.btnLockBWSR, 5, 2, 2, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxBandwidth, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.sliderGain, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxGain, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.sliderBasebandGain, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxBasebandGain, 9, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxFreqCorrection, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBoxDirectSampling, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinBoxNRepeat, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_BitLen, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_Center, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_ErrorTolerance, 16, 1, 1, 1)
        ...
        self.combox_sniff_Modulation.addItem("")
        self.combox_sniff_Modulation.addItem("")
        self.gridLayout.addWidget(self.combox_sniff_Modulation, 17, 1, 1, 1)
        ...
        self.comboBox_sniff_viewtype.addItem("")
        self.comboBox_sniff_viewtype.addItem("")
        self.gridLayout.addWidget(self.comboBox_sniff_viewtype, 18, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 19, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.txtEditErrors, 21, 0, 1, 3)
