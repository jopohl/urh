...
class Ui_DialogOptions(object):
    def setupUi(self, DialogOptions):
        ...
        self.gridLayout_2.addWidget(self.lineEditPython2Interpreter, 1, 2, 1, 1)
        self.checkBoxCustomSitePackagePath = QtWidgets.QCheckBox(self.groupBox_3)
        self.checkBoxCustomSitePackagePath.setObjectName("checkBoxCustomSitePackagePath")
        self.gridLayout_2.addWidget(self.checkBoxCustomSitePackagePath, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lGnuradioInstalled, 3, 0, 1, 3)
        self.lineEditCustomSitePackagePath = QtWidgets.QLineEdit(self.groupBox_3)
        self.lineEditCustomSitePackagePath.setEnabled(True)
        self.lineEditCustomSitePackagePath.setObjectName("lineEditCustomSitePackagePath")
        self.gridLayout_2.addWidget(self.lineEditCustomSitePackagePath, 2, 2, 1, 1)
    ...
    def retranslateUi(self, DialogOptions):
        ...
        self.checkBoxCustomSitePackagePath.setToolTip(_translate("DialogOptions", "<html><head/><body><p>If you installed Gnuradio with a bundled python interpreter, you need to enter the site-packages path of the installation here. The path should be something like <span style=\" font-style:italic;\">C:\\Program Files\\GNURadio-3.7\\lib\\site-packages</span>.</p></body></html>"))
        self.checkBoxCustomSitePackagePath.setText(_translate("DialogOptions", "Custom site package path:"))
        self.lGnuradioInstalled.setText(_translate("DialogOptions", "Gnuradio installation found"))
        self.lineEditCustomSitePackagePath.setToolTip(_translate("DialogOptions", "<html><head/><body><p>If you installed Gnuradio with a bundled python interpreter, you need to enter the site-packages path of the installation here. The path should be something like <span style=\" font-style:italic;\">C:\\Program Files\\GNURadio-3.7\\lib\\site-packages</span>.</p></body></html>"))
