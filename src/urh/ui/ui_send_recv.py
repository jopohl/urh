...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 17, 2, 1, 1)
        ...
        self.comboBox_sniff_viewtype.addItem("")
        self.comboBox_sniff_viewtype.addItem("")
        self.gridLayout.addWidget(self.comboBox_sniff_viewtype, 16, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_OutputFile, 17, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_viewtype, 16, 0, 1, 1)
