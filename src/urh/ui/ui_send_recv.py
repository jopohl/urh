...
"}")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 631, 1490))
        ...
        self.gridLayout.addWidget(self.txtEditErrors, 3, 0, 1, 3)
...
"}")
        ...
        self.checkBoxTimestamp = QtWidgets.QCheckBox(self.frame)
        self.checkBoxTimestamp.setObjectName("checkBoxTimestamp")
        self.horizontalLayout_3.addWidget(self.checkBoxTimestamp)
...
"}")
        ...
        self.groupBoxDeviceSettings = QtWidgets.QGroupBox(self.scrollAreaWidgetContents_2)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"}")
        ...
        self.gridLayout.addWidget(self.groupBoxDeviceSettings, 0, 0, 1, 3)
        ...
        SendRecvDialog.setTabOrder(self.comboBoxAntenna, self.lineEditIP)
        ...
        SendRecvDialog.setTabOrder(self.spinBoxSampleRate, self.btnLockBWSR)
        SendRecvDialog.setTabOrder(self.btnLockBWSR, self.spinBoxBandwidth)
        SendRecvDialog.setTabOrder(self.spinBoxBandwidth, self.sliderGain)
        SendRecvDialog.setTabOrder(self.sliderGain, self.spinBoxGain)
        SendRecvDialog.setTabOrder(self.spinBoxGain, self.sliderIFGain)
        ...
        SendRecvDialog.setTabOrder(self.spinBoxNRepeat, self.groupBoxSniffSettings)
        SendRecvDialog.setTabOrder(self.groupBoxSniffSettings, self.spinbox_sniff_Noise)
        SendRecvDialog.setTabOrder(self.spinbox_sniff_Noise, self.spinbox_sniff_Center)
        ...
        SendRecvDialog.setTabOrder(self.comboBox_sniff_viewtype, self.checkBoxTimestamp)
        SendRecvDialog.setTabOrder(self.checkBoxTimestamp, self.lineEdit_sniff_OutputFile)
    ...
    def retranslateUi(self, SendRecvDialog):
        ...
        self.checkBoxTimestamp.setText(_translate("SendRecvDialog", "Show timestamp"))
