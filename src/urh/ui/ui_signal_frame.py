...
class Ui_SignalFrame(object):
    def setupUi(self, SignalFrame):
        ...
        self.gridLayout_2.addWidget(self.sliderSpectrogramMin, 18, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sliderSpectrogramMax, 19, 1, 1, 1)
        self.labelSpectrogramMin = QtWidgets.QLabel(SignalFrame)
        self.labelSpectrogramMin.setObjectName("labelSpectrogramMin")
        self.gridLayout_2.addWidget(self.labelSpectrogramMin, 18, 0, 1, 1)
        self.labelSpectrogramMax = QtWidgets.QLabel(SignalFrame)
        self.labelSpectrogramMax.setObjectName("labelSpectrogramMax")
        self.gridLayout_2.addWidget(self.labelSpectrogramMax, 19, 0, 1, 1)
        self.labelPauseThreshold = QtWidgets.QLabel(SignalFrame)
        self.labelPauseThreshold.setObjectName("labelPauseThreshold")
        self.gridLayout_2.addWidget(self.labelPauseThreshold, 20, 0, 1, 1)
        self.spinBoxPauseThreshold = QtWidgets.QSpinBox(SignalFrame)
        self.spinBoxPauseThreshold.setMinimum(-1)
        ...
        self.gridLayout_2.addWidget(self.spinBoxPauseThreshold, 20, 1, 1, 1)
...
"If you want your protocol to be better seperated, edit the PauseLen using right-click menu from a selection in SignalView or ProtocolView."))
        ...
        self.labelPauseThreshold.setToolTip(_translate("SignalFrame", "<html><head/><body><p>The pause threshold gives you control <span style=\" font-weight:600;\">when to insert a message break.</span></p><p>The pause threshold is the maximum length of consecutive zero bits before a new message begins.</p><p>Special value is -1 to disable message breaking completely.</p></body></html>"))
        self.labelPauseThreshold.setText(_translate("SignalFrame", "Pause Threshold:"))
        self.spinBoxPauseThreshold.setToolTip(_translate("SignalFrame", "<html><head/><body><p>The pause threshold gives you control <span style=\" font-weight:600;\">when to insert a message break.</span></p><p>The pause threshold is the maximum length of consecutive zero bits before a new message begins.</p><p>Special value is -1 to disable message breaking completely.</p></body></html>"))
        self.spinBoxPauseThreshold.setSpecialValueText(_translate("SignalFrame", "Disable"))
