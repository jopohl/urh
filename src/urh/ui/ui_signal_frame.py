...
"}")
        ...
        self.lYScale = QtWidgets.QLabel(self.pageSignal)
        ...
        self.sliderYScale = QtWidgets.QSlider(self.pageSignal)
        ...
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.pageSpectrogram)
        ...
        self.horizontalLayout_2.addWidget(self.gvSpectrogram)
        self.graphicsViewColorbar = QtWidgets.QGraphicsView(self.pageSpectrogram)
        self.graphicsViewColorbar.setMaximumSize(QtCore.QSize(100, 16777215))
        self.graphicsViewColorbar.setFrameShape(QtWidgets.QFrame.NoFrame)
        self.graphicsViewColorbar.setObjectName("graphicsViewColorbar")
        self.horizontalLayout_2.addWidget(self.graphicsViewColorbar)
