...
class Ui_DialogSimulator(object):
    def setupUi(self, DialogSimulator):
        ...
        self.tabWidgetSimulatorSettings = QtWidgets.QTabWidget(parent=DialogSimulator)
        ...
        self.gvSimulator = LoggingGraphicsView(parent=self.tabLog)
        self.gvSimulator.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.gvSimulator.setObjectName("gvSimulator")
        self.verticalLayout_3.addWidget(self.gvSimulator)
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.btnLogAll = QtWidgets.QPushButton(parent=self.tabLog)
        self.btnLogAll.setAutoDefault(False)
        self.btnLogAll.setObjectName("btnLogAll")
        self.horizontalLayout.addWidget(self.btnLogAll)
        self.btnLogNone = QtWidgets.QPushButton(parent=self.tabLog)
        ...
        self.btnToggleLog = QtWidgets.QPushButton(parent=self.tabLog)
        ...
        self.scrollAreaRX = QtWidgets.QScrollArea(parent=self.tabRX)
        self.scrollAreaRX.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.btnTestSniffSettings = QtWidgets.QPushButton(parent=self.scrollAreaWidgetContentsRX)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/sniffer.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.scrollAreaTX = QtWidgets.QScrollArea(parent=self.tabTX)
        self.scrollAreaTX.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.tabWidget = QtWidgets.QTabWidget(parent=self.tabSimulation)
        ...
        self.groupBoxSimulationStatus = QtWidgets.QGroupBox(parent=self.tab_simulation)
...
"}")
        ...
        self.frame = QtWidgets.QFrame(parent=self.groupBoxSimulationStatus)
        ...
        self.textEditSimulation = QtWidgets.QTextEdit(parent=self.frame)
        ...
        self.lblCurrentRepeatValue = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lblCurrentItemValue = QtWidgets.QLabel(parent=self.frame)
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.lblCurrentItemValue.setFont(font)
        self.lblCurrentItemValue.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lblCurrentItemValue.setObjectName("lblCurrentItemValue")
        self.horizontalLayout_2.addWidget(self.lblCurrentItemValue)
        self.btnSaveLog = QtWidgets.QToolButton(parent=self.frame)
        ...
        self.groupBoxRXStatus = QtWidgets.QGroupBox(parent=self.tab_simulation)
...
"}")
        ...
        self.frame_2 = QtWidgets.QFrame(parent=self.groupBoxRXStatus)
        ...
        self.checkBoxCaptureFullRX = QtWidgets.QCheckBox(parent=self.frame_2)
        ...
        self.btnSaveRX = QtWidgets.QToolButton(parent=self.frame_2)
        icon = QtGui.QIcon.fromTheme("document-save")
        ...
        self.graphicsViewPreview = LiveGraphicView(parent=self.frame_2)
        ...
        self.textEditTranscript = QtWidgets.QTextEdit(parent=self.tab)
        ...
        self.radioButtonTranscriptBit = QtWidgets.QRadioButton(parent=self.tab)
        ...
        self.radioButtonTranscriptHex = QtWidgets.QRadioButton(parent=self.tab)
        ...
        self.btnOpenInAnalysis = QtWidgets.QPushButton(parent=self.tab)
        self.btnOpenInAnalysis.setObjectName("btnOpenInAnalysis")
        self.horizontalLayout_3.addWidget(self.btnOpenInAnalysis)
        self.btnSaveTranscript = QtWidgets.QToolButton(parent=self.tab)
        icon = QtGui.QIcon.fromTheme("document-save")
        ...
        self.textEditDevices = QtWidgets.QTextEdit(parent=self.tab_device)
        ...
        self.btnStartStop = QtWidgets.QPushButton(parent=self.tabSimulation)
        ...
        self.groupBoxSimulationStatus.toggled['bool'].connect(self.frame.setVisible) # type: ignore
        self.groupBoxRXStatus.toggled['bool'].connect(self.frame_2.setVisible) # type: ignore
