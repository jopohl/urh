...
"}")
        ...
        self.gridLayout_4.addWidget(self.spinbox_sniff_Noise, 1, 1, 1, 1)
        self.label_sniff_OutputFile = QtWidgets.QLabel(self.frame)
        self.label_sniff_OutputFile.setObjectName("label_sniff_OutputFile")
        self.gridLayout_4.addWidget(self.label_sniff_OutputFile, 9, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spinbox_sniff_BitLen, 3, 1, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.spinbox_sniff_Center, 2, 1, 1, 1)
        self.label_sniff_Modulation = QtWidgets.QLabel(self.frame)
        self.label_sniff_Modulation.setObjectName("label_sniff_Modulation")
        self.gridLayout_4.addWidget(self.label_sniff_Modulation, 5, 0, 1, 1)
        ...
        self.combox_sniff_Modulation.addItem("")
        self.combox_sniff_Modulation.addItem("")
        self.gridLayout_4.addWidget(self.combox_sniff_Modulation, 5, 1, 1, 1)
        self.label_sniff_viewtype = QtWidgets.QLabel(self.frame)
        self.label_sniff_viewtype.setObjectName("label_sniff_viewtype")
        self.gridLayout_4.addWidget(self.label_sniff_viewtype, 7, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.label_sniff_Center, 2, 0, 1, 1)
