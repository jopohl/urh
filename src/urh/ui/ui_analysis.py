...
"}")
    ...
    def retranslateUi(self, TabAnalysis):
        TabAnalysis.setWindowTitle(QtWidgets.QApplication.translate("TabAnalysis", "Frame", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_protocols), QtWidgets.QApplication.translate("TabAnalysis", "Protocols", None, -1))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_participants), QtWidgets.QApplication.translate("TabAnalysis", "Participants", None, -1))
        self.label_4.setText(QtWidgets.QApplication.translate("TabAnalysis", "View data as:", None, -1))
        self.cbProtoView.setToolTip(QtWidgets.QApplication.translate("TabAnalysis", "<html><head/><body><p>Set the desired view here.</p></body></html>", None, -1))
        self.cbProtoView.setItemText(0, QtWidgets.QApplication.translate("TabAnalysis", "Bits", None, -1))
        ...
        self.chkBoxShowOnlyDiffs.setText(QtWidgets.QApplication.translate("TabAnalysis", "Show only diffs in protocol", None, -1))
        self.chkBoxOnlyShowLabelsInProtocol.setText(QtWidgets.QApplication.translate("TabAnalysis", "Show only labels in protocol", None, -1))
        self.btnAnalyze.setText(QtWidgets.QApplication.translate("TabAnalysis", "Analyze", None, -1))
        self.btnSaveProto.setToolTip(QtWidgets.QApplication.translate("TabAnalysis", "Save current protocol.", None, -1))
        self.lSlash.setText(QtWidgets.QApplication.translate("TabAnalysis", "/", None, -1))
        self.lblShownRows.setText(QtWidgets.QApplication.translate("TabAnalysis", "shown: 42/108", None, -1))
        self.lTime.setToolTip(QtWidgets.QApplication.translate("TabAnalysis", "<html><head/><body><p>The <span style=\" font-weight:600;\">Message</span><span style=\" font-weight:600;\">Start</span> is the point in time when a protocol message begins. Additionally the relative time (+ ...) from the previous message is shown.</p></body></html>", None, -1))
        self.lTime.setText(QtWidgets.QApplication.translate("TabAnalysis", "0 (+0)", None, -1))
        self.lSearchCurrent.setText(QtWidgets.QApplication.translate("TabAnalysis", "-", None, -1))
        self.lblRSSI.setToolTip(QtWidgets.QApplication.translate("TabAnalysis", "<html><head/><body><p>This is the average signal power of the current message. The nearer this value is to zero, the stronger the signal is.</p></body></html>", None, -1))
        self.lblRSSI.setText(QtWidgets.QApplication.translate("TabAnalysis", "-∞ dBm", None, -1))
        self.btnNextSearch.setText(QtWidgets.QApplication.translate("TabAnalysis", ">", None, -1))
        self.btnPrevSearch.setText(QtWidgets.QApplication.translate("TabAnalysis", "<", None, -1))
        self.lSearchTotal.setText(QtWidgets.QApplication.translate("TabAnalysis", "-", None, -1))
        self.label_3.setToolTip(QtWidgets.QApplication.translate("TabAnalysis", "<html><head/><body><p>The <span style=\" font-weight:600;\">Message Start</span> is the point in time when a protocol message begins. Additionally the relative time (+ ...) from the previous message is shown.</p></body></html>", None, -1))
        self.label_3.setText(QtWidgets.QApplication.translate("TabAnalysis", "Timestamp:", None, -1))
        self.btnSearchSelectFilter.setText(QtWidgets.QApplication.translate("TabAnalysis", "Search", None, -1))
        self.btnLoadProto.setToolTip(QtWidgets.QApplication.translate("TabAnalysis", "Load a protocol.", None, -1))
        self.btnLoadProto.setText(QtWidgets.QApplication.translate("TabAnalysis", "...", None, -1))
        self.lblClearAlignment.setText(QtWidgets.QApplication.translate("TabAnalysis", "<html><head/><body><p><a href=\"reset_alignment\"><span style=\" text-decoration: underline; color:#0000ff;\">Reset alignment</span></a></p></body></html>", None, -1))
        self.lineEditSearch.setPlaceholderText(QtWidgets.QApplication.translate("TabAnalysis", "Enter pattern here", None, -1))
        self.lBits.setText(QtWidgets.QApplication.translate("TabAnalysis", "Bit:", None, -1))
        self.lHex.setText(QtWidgets.QApplication.translate("TabAnalysis", "Hex:", None, -1))
        self.lDecimal.setText(QtWidgets.QApplication.translate("TabAnalysis", "Decimal:", None, -1))
        self.lNumSelectedColumns.setText(QtWidgets.QApplication.translate("TabAnalysis", "0", None, -1))
        self.lColumnsSelectedText.setText(QtWidgets.QApplication.translate("TabAnalysis", "column(s) selected", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("TabAnalysis", "Message types", None, -1))
        self.lblLabelValues.setText(QtWidgets.QApplication.translate("TabAnalysis", "Labels for message", None, -1))
