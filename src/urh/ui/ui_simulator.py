...
class Ui_SimulatorTab(object):
    def setupUi(self, SimulatorTab):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 527, 410))
    ...
    def retranslateUi(self, SimulatorTab):
        ...
        self.pushButton.setText(_translate("SimulatorTab", "Add message ..."))
        self.label_8.setText(_translate("SimulatorTab", "Labels:"))
        self.label_9.setText(_translate("SimulatorTab", "Message:"))
