...
class TestDemodulations(unittest.TestCase):
    ...
    def test_ask_two(self):
        signal = IQSignal(get_path_for_data_file("ask_short.complex"), "ASK-Test2")
        signal.modulation_type = 0
    ...
    def test_fsk(self):
        signal = IQSignal(get_path_for_data_file("fsk.complex"), "FSK-Test")
    ...
    def test_psk(self):
        signal = IQSignal(get_path_for_data_file("psk_gen_noisy.complex"), "PSK-Test")
