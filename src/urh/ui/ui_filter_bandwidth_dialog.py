...
class Ui_DialogFilterBandwidth(object):
    def setupUi(self, DialogFilterBandwidth):
        ...
        self.labelExplanation = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelExplanation.setAlignment(QtCore.Qt.AlignmentFlag.AlignJustify|QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.doubleSpinBoxCustomBandwidth = QtWidgets.QDoubleSpinBox(parent=DialogFilterBandwidth)
        ...
        self.spinBoxCustomKernelLength = QtWidgets.QSpinBox(parent=DialogFilterBandwidth)
        ...
        self.radioButtonCustom = QtWidgets.QRadioButton(parent=DialogFilterBandwidth)
        self.radioButtonCustom.setObjectName("radioButtonCustom")
        self.gridLayout.addWidget(self.radioButtonCustom, 7, 0, 1, 1)
        self.labelMediumKernelLength = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.radioButtonWide = QtWidgets.QRadioButton(parent=DialogFilterBandwidth)
        self.radioButtonWide.setObjectName("radioButtonWide")
        self.gridLayout.addWidget(self.radioButtonWide, 5, 0, 1, 1)
        self.labelVeryWideKernelLength = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelBandwidthCaption = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelNarrowBandwidth = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        self.labelNarrowBandwidth.setObjectName("labelNarrowBandwidth")
        self.gridLayout.addWidget(self.labelNarrowBandwidth, 3, 1, 1, 1)
        self.labelNarrowKernelLength = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelVeryNarrowBandwidth = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelKernelLengthCaption = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelWideKernelLength = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.radioButtonVery_Wide = QtWidgets.QRadioButton(parent=DialogFilterBandwidth)
        self.radioButtonVery_Wide.setObjectName("radioButtonVery_Wide")
        self.gridLayout.addWidget(self.radioButtonVery_Wide, 6, 0, 1, 1)
        self.radioButtonVery_Narrow = QtWidgets.QRadioButton(parent=DialogFilterBandwidth)
        ...
        self.label = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.labelVeryWideBandwidth = QtWidgets.QLabel(parent=DialogFilterBandwidth)
        ...
        self.buttonBox.accepted.connect(DialogFilterBandwidth.accept) # type: ignore
        self.buttonBox.rejected.connect(DialogFilterBandwidth.reject) # type: ignore
