...
class Ui_DialogFilterBandwidth(object):
    def setupUi(self, DialogFilterBandwidth):
        ...
        self.labelExplanation.setAlignment(
        ...
        self.spinBoxCustomKernelLength = QtWidgets.QSpinBox(
            parent=DialogFilterBandwidth
        )
        ...
        self.labelVeryNarrowKernelLength = QtWidgets.QLabel(
            parent=DialogFilterBandwidth
        )
        ...
        self.radioButtonVery_Narrow = QtWidgets.QRadioButton(
            parent=DialogFilterBandwidth
        )
