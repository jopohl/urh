...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_Noise, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_Modulation, 11, 0, 1, 1)
        ...
        self.combox_sniff_Modulation.addItem("")
        self.combox_sniff_Modulation.addItem("")
        self.gridLayout.addWidget(self.combox_sniff_Modulation, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_OutputFile, 13, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 13, 1, 1, 1)
        self.label_sniff_BitLength = QtWidgets.QLabel(SendRecvDialog)
        self.label_sniff_BitLength.setObjectName("label_sniff_BitLength")
        self.gridLayout.addWidget(self.label_sniff_BitLength, 7, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_BitLen, 7, 1, 1, 1)
        self.label_sniff_Tolerance = QtWidgets.QLabel(SendRecvDialog)
        self.label_sniff_Tolerance.setObjectName("label_sniff_Tolerance")
        self.gridLayout.addWidget(self.label_sniff_Tolerance, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_ErrorTolerance, 10, 1, 1, 1)
