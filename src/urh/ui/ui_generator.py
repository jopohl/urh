...
class Ui_GeneratorTab(object):
    def setupUi(self, GeneratorTab):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1180, 686))
...
"}")
        ...
        self.gridLayout_2.setContentsMargins(0, 0, 0, 11)
        ...
        self.tableMessages.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.gridLayout_2.addWidget(self.btnSave, 2, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btnNetworkSDRSend, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btnRfCatSend, 2, 2, 1, 1)
