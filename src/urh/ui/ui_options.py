...
class Ui_DialogOptions(object):
    def setupUi(self, DialogOptions):
        ...
        self.labenIncludeDirs = QtWidgets.QLabel(self.groupBox_2)
        self.labenIncludeDirs.setObjectName("labenIncludeDirs")
        self.gridLayout_5.addWidget(self.labenIncludeDirs, 2, 0, 1, 1)
        self.lineEditLibraries = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEditLibraries.setObjectName("lineEditLibraries")
        self.gridLayout_5.addWidget(self.lineEditLibraries, 3, 1, 1, 1)
        self.labelLibDirs = QtWidgets.QLabel(self.groupBox_2)
        self.labelLibDirs.setObjectName("labelLibDirs")
        self.gridLayout_5.addWidget(self.labelLibDirs, 4, 0, 1, 1)
        self.labelLibraries = QtWidgets.QLabel(self.groupBox_2)
        self.labelLibraries.setObjectName("labelLibraries")
        self.gridLayout_5.addWidget(self.labelLibraries, 3, 0, 1, 1)
        ...
        self.lineEditLibDirs = QtWidgets.QLineEdit(self.groupBox_2)
        self.lineEditLibDirs.setObjectName("lineEditLibDirs")
        self.gridLayout_5.addWidget(self.lineEditLibDirs, 4, 1, 1, 1)
        self.labelWindowsError = QtWidgets.QLabel(self.groupBox_2)
