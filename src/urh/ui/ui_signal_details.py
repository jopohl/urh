...
class Ui_SignalDetails(object):
    def setupUi(self, SignalDetails):
        ...
        self.label = QtWidgets.QLabel(parent=SignalDetails)
        ...
        self.label_5 = QtWidgets.QLabel(parent=SignalDetails)
        self.label_5.setObjectName("label_5")
        self.gridLayout.addWidget(self.label_5, 4, 0, 1, 1)
        self.label_6 = QtWidgets.QLabel(parent=SignalDetails)
        self.label_6.setObjectName("label_6")
        self.gridLayout.addWidget(self.label_6, 5, 0, 1, 1)
        self.lblSamplesTotal = QtWidgets.QLabel(parent=SignalDetails)
        self.lblSamplesTotal.setObjectName("lblSamplesTotal")
        self.gridLayout.addWidget(self.lblSamplesTotal, 4, 1, 1, 1)
        self.label_3 = QtWidgets.QLabel(parent=SignalDetails)
        ...
        self.label_4 = QtWidgets.QLabel(parent=SignalDetails)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 3, 0, 1, 1)
        self.lFileCreated = QtWidgets.QLabel(parent=SignalDetails)
        self.lFileCreated.setObjectName("lFileCreated")
        self.gridLayout.addWidget(self.lFileCreated, 3, 1, 1, 1)
        self.label_7 = QtWidgets.QLabel(parent=SignalDetails)
        self.label_7.setObjectName("label_7")
        self.gridLayout.addWidget(self.label_7, 6, 0, 1, 1)
        self.lDuration = QtWidgets.QLabel(parent=SignalDetails)
