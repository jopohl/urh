...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_Noise, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_BitLen, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_Modulation, 10, 0, 1, 1)
        ...
        self.combox_sniff_Modulation.addItem("")
        self.combox_sniff_Modulation.addItem("")
        self.gridLayout.addWidget(self.combox_sniff_Modulation, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_OutputFile, 11, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 11, 1, 1, 1)
