...
class Ui_SimulatorTab(object):
    def setupUi(self, SimulatorTab):
        ...
        self.tblViewSimulatorRuleset.setAlternatingRowColors(True)
        self.tblViewSimulatorRuleset.setShowGrid(False)
        self.tblViewSimulatorRuleset.setObjectName("tblViewSimulatorRuleset")
        self.tblViewSimulatorRuleset.horizontalHeader().setDefaultSectionSize(150)
        self.tblViewSimulatorRuleset.horizontalHeader().setStretchLastSection(True)
        self.tblViewSimulatorRuleset.verticalHeader().setVisible(False)
