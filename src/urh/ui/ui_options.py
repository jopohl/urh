...
class Ui_DialogOptions(object):
    def setupUi(self, DialogOptions):
        ...
        self.lineEditGnuradioDirectory.setText("")
    ...
    def retranslateUi(self, DialogOptions):
        ...
        self.groupBox_3.setTitle(_translate("DialogOptions", "GNU Radio options"))
        self.label_11.setText(_translate("DialogOptions", "Needed for GNU Radio backend only"))
        self.lineEditPython2Interpreter.setToolTip(_translate("DialogOptions", "<html><head/><body><p>Use this option if you installed GNU Radio with your package manager e.g. on Linux and Mac OS X.</p></body></html>"))
        self.lineEditPython2Interpreter.setPlaceholderText(_translate("DialogOptions", "/usr/bin/python2"))
        self.lGnuradioInstalled.setText(_translate("DialogOptions", "GNU Radio installation found"))
        ...
        self.lineEditGnuradioDirectory.setPlaceholderText(_translate("DialogOptions", "C:\\Program Files\\GNURadio"))
        self.radioButtonPython2Interpreter.setToolTip(_translate("DialogOptions", "<html><head/><body><p>Use this option if you installed GNU Radio with your package manager e.g. on Linux and Mac OS X.</p></body></html>"))
        ...
        self.radioButtonGnuradioDirectory.setText(_translate("DialogOptions", "GNU Radio Directory"))
