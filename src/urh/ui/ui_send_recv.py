...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 387, 1083))
        ...
        self.gridLayout.addWidget(self.groupBox, 22, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.txtEditErrors, 23, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 21, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_sniff_OutputFile, 21, 0, 1, 1)
