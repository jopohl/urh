...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.gridLayout.addWidget(self.label_sniff_OutputFile, 12, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 12, 1, 1, 1)
