...
"}")
        ...
        self.lineEditSearch1 = QtWidgets.QLineEdit(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lineEditSearch1.sizePolicy().hasHeightForWidth())
        self.lineEditSearch1.setSizePolicy(sizePolicy)
        self.lineEditSearch1.setAcceptDrops(False)
        self.lineEditSearch1.setClearButtonEnabled(True)
        self.lineEditSearch1.setObjectName("lineEditSearch1")
        self.gridLayout_2.addWidget(self.lineEditSearch1, 0, 1, 1, 1)
...
"}")
    ...
    def retranslateUi(self, TabAnalysis):
        ...
        self.lineEditSearch1.setPlaceholderText(_translate("TabAnalysis", "Search Pattern"))
