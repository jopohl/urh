...
class Ui_DialogOptions(object):
    def setupUi(self, DialogOptions):
        ...
        self.labenIncludeDirs = QtWidgets.QLabel(self.groupBoxNativeOptions)
        ...
        self.gridLayout_5.addWidget(self.labelNativeRebuildInfo, 1, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.btnRebuildNative, 4, 1, 1, 1)
