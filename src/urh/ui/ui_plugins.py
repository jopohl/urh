...
# Form implementation generated from reading ui file '/home/joe/urh/ui/plugins.ui'
#
...
class Ui_FramePlugins(object):
    def setupUi(self, FramePlugins):
        ...
        self.txtEditPluginDescription.setProperty("placeholderText", "")
        ...
        self.groupBoxSettings.setMinimumSize(QtCore.QSize(0, 250))
        self.groupBoxSettings.setMaximumSize(QtCore.QSize(16777215, 250))
