...
# Form implementation generated from reading ui file '/home/joe/GIT/urh/data/ui/send_recv.ui',
# licensing of '/home/joe/GIT/urh/data/ui/send_recv.ui' applies.
#
#
...
"}")
    ...
    def retranslateUi(self, SendRecvDialog):
        SendRecvDialog.setWindowTitle(QtWidgets.QApplication.translate("SendRecvDialog", "Record Signal", None, -1))
        self.progressBarMessage.setFormat(QtWidgets.QApplication.translate("SendRecvDialog", "%v/%m", None, -1))
        self.labelCurrentMessage.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Current message:", None, -1))
        self.lReceiveBufferFullText.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Receive buffer full:", None, -1))
        self.progressBarSample.setFormat(QtWidgets.QApplication.translate("SendRecvDialog", "%v/%m", None, -1))
        self.lSamplesSentText.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Current sample:", None, -1))
        self.lTimeText.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Time (in seconds):", None, -1))
        self.lSamplesCapturedText.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Samples captured:", None, -1))
        self.lSignalSizeText.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Signal size (in MiB):", None, -1))
        self.lSamplesCaptured.setText(QtWidgets.QApplication.translate("SendRecvDialog", "0", None, -1))
        self.lTime.setText(QtWidgets.QApplication.translate("SendRecvDialog", "0", None, -1))
        self.lSignalSize.setText(QtWidgets.QApplication.translate("SendRecvDialog", "0", None, -1))
        self.lblRepeatText.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Current iteration:", None, -1))
        self.lblCurrentRepeatValue.setText(QtWidgets.QApplication.translate("SendRecvDialog", "0", None, -1))
        self.labelReceiveBufferFull.setText(QtWidgets.QApplication.translate("SendRecvDialog", "0%", None, -1))
        self.btnStart.setToolTip(QtWidgets.QApplication.translate("SendRecvDialog", "Record signal", None, -1))
        self.btnStart.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Start", None, -1))
        self.btnStop.setToolTip(QtWidgets.QApplication.translate("SendRecvDialog", "Stop recording", None, -1))
        self.btnStop.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Stop", None, -1))
        self.btnSave.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Save...", None, -1))
        self.btnClear.setToolTip(QtWidgets.QApplication.translate("SendRecvDialog", "Clear", None, -1))
        self.btnClear.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Clear", None, -1))
        self.label_7.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Hint: You can edit the raw signal before sending.", None, -1))
        self.btnAccept.setToolTip(QtWidgets.QApplication.translate("SendRecvDialog", "<html><head/><body><p>Accept the sniffed data and load it into <span style=\" font-weight:600;\">Analysis</span> tab.</p></body></html>", None, -1))
        self.btnAccept.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Accept data (Open in Analysis)", None, -1))
        self.label_y_scale.setText(QtWidgets.QApplication.translate("SendRecvDialog", "Y-Scale", None, -1))
