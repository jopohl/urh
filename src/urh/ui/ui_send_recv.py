...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        SendRecvDialog.resize(850, 1001)
    ...
    def retranslateUi(self, SendRecvDialog):
        ...
        self.labelDeviceArgs.setToolTip(_translate("SendRecvDialog", "<html><head/><body><p>If you only have one USRP connected you may leave this field empty, so your USRP gets detected automatically.</p><p>If you have multiple USRPs connected or need better control, enter a device identifier of your USRP here. You can find a list of supported identifiers <a href=\"http://files.ettus.com/manual/page_identification.html\"><span style=\" text-decoration: underline; color:#0000ff;\">here</span></a>.</p><p>You may also enter other device arguments here. You can lookup these values <a href=\"http://files.ettus.com/manual/page_configuration.html\"><span style=\" text-decoration: underline; color:#0000ff;\">here</span></a>.</p></body></html>"))
