...
class Ui_DialogSimulator(object):
    def setupUi(self, DialogSimulator):
        ...
        self.scrollAreaWidgetContentsRX.setGeometry(QtCore.QRect(0, 0, 1076, 781))
        ...
        self.scrollAreaWidgetContentsTX.setGeometry(QtCore.QRect(0, 0, 1076, 781))
...
"}")
    ...
    def retranslateUi(self, DialogSimulator):
        ...
        self.checkBoxCaptureFullRX.setText(_translate("DialogSimulator", "Capture complex file"))
