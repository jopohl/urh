...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "language": "c++",
        "name": "urh.cythonext.awre_util",
        "sources": [
            "src/urh/cythonext/awre_util.pyx"
        ]
    },
    "module_name": "urh.cythonext.awre_util"
}
END: Cython Metadata */
...
#define __PYX_HAVE__urh__cythonext__awre_util
#define __PYX_HAVE_API__urh__cythonext__awre_util
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* ObjectToMemviewSlice.proto */
static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(PyObject *, int writable_flag);
...
/* Module declarations from 'urh.cythonext.awre_util' */
...
#define __Pyx_MODULE_NAME "urh.cythonext.awre_util"
extern int __pyx_module_is_main_urh__cythonext__awre_util;
int __pyx_module_is_main_urh__cythonext__awre_util = 0;

/* Implementation of 'urh.cythonext.awre_util' */
...
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_1build_xor_matrix(PyObject *__pyx_self, PyObject *__pyx_v_bitvectors); /*proto*/
static PyArrayObject *__pyx_f_3urh_9cythonext_9awre_util_build_xor_matrix(PyObject *__pyx_v_bitvectors, CYTHON_UNUSED int __pyx_skip_dispatch) {
 ...
 */
  ...
  /* "urh/cythonext/awre_util.pyx":11
 *     cdef np.uint8_t[:] bitvector_i, bitvector_j
 *     cdef int i, j, l
 ...
 */
  ...
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_bitvectors); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "urh/cythonext/awre_util.pyx":12
 *     cdef int i, j, l
 *     for i in range(0, len(bitvectors)):
 *         bitvector_i = bitvectors[i]             # <<<<<<<<<<<<<<
 *         if maximum < len(bitvector_i):
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(PyList_GET_ITEM(__pyx_v_bitvectors, __pyx_v_i), PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 12, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_v_bitvector_i, 1);
    __pyx_v_bitvector_i = __pyx_t_4;
    __pyx_t_4.memview = NULL;
    __pyx_t_4.data = NULL;

    /* "urh/cythonext/awre_util.pyx":13
 *     for i in range(0, len(bitvectors)):
 *         bitvector_i = bitvectors[i]
 *         if maximum < len(bitvector_i):             # <<<<<<<<<<<<<<
 *             maximum = len(bitvector_i)
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "urh/cythonext/awre_util.pyx":14
 *         bitvector_i = bitvectors[i]
 *         if maximum < len(bitvector_i):
 *             maximum = len(bitvector_i)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "urh/cythonext/awre_util.pyx":16
 *             maximum = len(bitvector_i)
 * 
 *     cdef np.ndarray[np.uint8_t, ndim=3] result = np.full((len(bitvectors), len(bitvectors), maximum), -1, dtype=np.uint8, order="C")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_7, __pyx_n_s_full); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_bitvectors); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 16, __pyx_L1_error)
  __pyx_t_7 = PyInt_FromSsize_t(__pyx_t_1); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  if (unlikely(__pyx_v_bitvectors == Py_None)) {
    PyErr_SetString(PyExc_TypeError, "object of type 'NoneType' has no len()");
    __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_bitvectors); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 16, __pyx_L1_error)
  __pyx_t_9 = PyInt_FromSsize_t(__pyx_t_1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_10 = __Pyx_PyInt_From_unsigned_int(__pyx_v_maximum); if (unlikely(!__pyx_t_10)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_10);
  __pyx_t_11 = PyTuple_New(3); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_PyDict_NewPresized(2); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_GetModuleGlobalName(__pyx_t_9, __pyx_n_s_np); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_7 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_uint8); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  if (PyDict_SetItem(__pyx_t_11, __pyx_n_s_dtype, __pyx_t_7) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  if (PyDict_SetItem(__pyx_t_11, __pyx_n_s_order, __pyx_n_u_C) < 0) __PYX_ERR(0, 16, __pyx_L1_error)
  __pyx_t_7 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_10, __pyx_t_11); if (unlikely(!__pyx_t_7)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_7);
  ...
  __pyx_t_12 = ((PyArrayObject *)__pyx_t_7);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_result.rcbuffer->pybuffer, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 3, 0, __pyx_stack) == -1)) {
  ...
  /* "urh/cythonext/awre_util.pyx":18
 *     cdef np.ndarray[np.uint8_t, ndim=3] result = np.full((len(bitvectors), len(bitvectors), maximum), -1, dtype=np.uint8, order="C")
 * 
 *     for i in range(len(bitvectors)):             # <<<<<<<<<<<<<<
 *         bitvector_i = bitvectors[i]
 ...
 */
  ...
  __pyx_t_1 = PyList_GET_SIZE(__pyx_v_bitvectors); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 18, __pyx_L1_error)
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "urh/cythonext/awre_util.pyx":19
 * 
 *     for i in range(len(bitvectors)):
 *         bitvector_i = bitvectors[i]             # <<<<<<<<<<<<<<
 *         for j in range(i+1, len(bitvectors)):
 ...
 */
    ...
    __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(PyList_GET_ITEM(__pyx_v_bitvectors, __pyx_v_i), PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 19, __pyx_L1_error)
    __PYX_XDEC_MEMVIEW(&__pyx_v_bitvector_i, 1);
    __pyx_v_bitvector_i = __pyx_t_4;
    __pyx_t_4.memview = NULL;
    __pyx_t_4.data = NULL;

    /* "urh/cythonext/awre_util.pyx":20
 *     for i in range(len(bitvectors)):
 *         bitvector_i = bitvectors[i]
 *         for j in range(i+1, len(bitvectors)):             # <<<<<<<<<<<<<<
 *             bitvector_j = bitvectors[j]
 ...
 */
    ...
    __pyx_t_13 = PyList_GET_SIZE(__pyx_v_bitvectors); if (unlikely(__pyx_t_13 == ((Py_ssize_t)-1))) __PYX_ERR(0, 20, __pyx_L1_error)
    __pyx_t_14 = __pyx_t_13;
    for (__pyx_t_15 = (__pyx_v_i + 1); __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      __pyx_v_j = __pyx_t_15;

      /* "urh/cythonext/awre_util.pyx":21
 *         bitvector_i = bitvectors[i]
 *         for j in range(i+1, len(bitvectors)):
 *             bitvector_j = bitvectors[j]             # <<<<<<<<<<<<<<
 *             l = min(len(bitvector_i), len(bitvector_j))
 ...
 */
      ...
      __pyx_t_4 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_5numpy_uint8_t(PyList_GET_ITEM(__pyx_v_bitvectors, __pyx_v_j), PyBUF_WRITABLE); if (unlikely(!__pyx_t_4.memview)) __PYX_ERR(0, 21, __pyx_L1_error)
      __PYX_XDEC_MEMVIEW(&__pyx_v_bitvector_j, 1);
      __pyx_v_bitvector_j = __pyx_t_4;
      __pyx_t_4.memview = NULL;
      __pyx_t_4.data = NULL;

      /* "urh/cythonext/awre_util.pyx":22
 *         for j in range(i+1, len(bitvectors)):
 *             bitvector_j = bitvectors[j]
 *             l = min(len(bitvector_i), len(bitvector_j))             # <<<<<<<<<<<<<<
 *             for k in range(0, l):
 ...
 */
      ...
      __pyx_t_16 = __Pyx_MemoryView_Len(__pyx_v_bitvector_i); 
      if (((__pyx_t_5 < __pyx_t_16) != 0)) {
      ...
      /* "urh/cythonext/awre_util.pyx":23
 *             bitvector_j = bitvectors[j]
 *             l = min(len(bitvector_i), len(bitvector_j))
 *             for k in range(0, l):             # <<<<<<<<<<<<<<
 *                 result[i,j,k] = bitvector_i[k] ^ bitvector_j[k]
 ...
 */
      ...
      for (__pyx_t_20 = 0; __pyx_t_20 < __pyx_t_19; __pyx_t_20+=1) {
        ...
        /* "urh/cythonext/awre_util.pyx":24
 *             l = min(len(bitvector_i), len(bitvector_j))
 *             for k in range(0, l):
 *                 result[i,j,k] = bitvector_i[k] ^ bitvector_j[k]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_result.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_result.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_result.diminfo[1].strides, __pyx_t_25, __pyx_pybuffernd_result.diminfo[2].strides) = ((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_bitvector_i.data + __pyx_t_21 * __pyx_v_bitvector_i.strides[0]) ))) ^ (*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ (__pyx_v_bitvector_j.data + __pyx_t_22 * __pyx_v_bitvector_j.strides[0]) ))));
      }
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("urh.cythonext.awre_util.build_xor_matrix", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_result.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_1build_xor_matrix(PyObject *__pyx_self, PyObject *__pyx_v_bitvectors); /*proto*/
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_1build_xor_matrix(PyObject *__pyx_self, PyObject *__pyx_v_bitvectors) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("build_xor_matrix (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_bitvectors), (&PyList_Type), 1, "bitvectors", 1))) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_r = __pyx_pf_3urh_9cythonext_9awre_util_build_xor_matrix(__pyx_self, ((PyObject*)__pyx_v_bitvectors));
...
static PyObject *__pyx_pf_3urh_9cythonext_9awre_util_build_xor_matrix(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_bitvectors) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("build_xor_matrix", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_3urh_9cythonext_9awre_util_build_xor_matrix(__pyx_v_bitvectors, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
...
static PyObject *__pyx_f_3urh_9cythonext_9awre_util_find_longest_common_sub_sequence_indices(__Pyx_memviewslice __pyx_v_seq1, __Pyx_memviewslice __pyx_v_seq2, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  unsigned int __pyx_v_longest;
  unsigned int __pyx_v_counter;
  unsigned int __pyx_v_len_bits1;
  unsigned int __pyx_v_len_bits2;
  unsigned short __pyx_v_max_results;
  unsigned short __pyx_v_current_result;
  __Pyx_memviewslice __pyx_v_m = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_result_indices = { 0, 0, { 0 }, { 0 }, { 0 } };
  ...
  /* "urh/cythonext/awre_util.pyx":29
 * 
 * cpdef set find_longest_common_sub_sequence_indices(np.uint8_t[::1] seq1, np.uint8_t[::1] seq2):
 *     cdef unsigned int i, j, longest = 0, counter = 0, len_bits1 = len(seq1), len_bits2 = len(seq2)             # <<<<<<<<<<<<<<
 *     cdef unsigned short max_results = 10, current_result = 0
 ...
 */
  __pyx_v_max_results = 10;
  __pyx_v_current_result = 0;

  /* "urh/cythonext/awre_util.pyx":32
 *     cdef unsigned short max_results = 10, current_result = 0
 * 
 *     cdef unsigned int[:, ::1] m = np.zeros((len_bits1+1, len_bits2+1), dtype=np.uint32, order="C")             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_len_bits1 + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_len_bits2 + 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 32, __pyx_L1_error)
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_6 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_uint32); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_6) < 0) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_order, __pyx_n_u_C) < 0) __PYX_ERR(0, 32, __pyx_L1_error)
  ...
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(__pyx_t_6, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_m = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "urh/cythonext/awre_util.pyx":33
 * 
 *     cdef unsigned int[:, ::1] m = np.zeros((len_bits1+1, len_bits2+1), dtype=np.uint32, order="C")
 *     cdef unsigned int[:, ::1] result_indices = np.zeros((max_results, 2), dtype=np.uint32, order="C")             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_From_unsigned_short(__pyx_v_max_results); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_uint32); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_2) < 0) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_order, __pyx_n_u_C) < 0) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_6, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(__pyx_t_2, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 33, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_v_result_indices = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "urh/cythonext/awre_util.pyx":35
 *     cdef unsigned int[:, ::1] result_indices = np.zeros((max_results, 2), dtype=np.uint32, order="C")
 * 
 *     for i in range(0, len_bits1):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "urh/cythonext/awre_util.pyx":36
 * 
 *     for i in range(0, len_bits1):
 *         for j in range(0, len_bits2):             # <<<<<<<<<<<<<<
 *             if seq1[i] == seq2[j]:
 *                 counter = m[i, j] + 1
 */
    __pyx_t_11 = __pyx_v_len_bits2;
    __pyx_t_12 = __pyx_t_11;
    for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
      __pyx_v_j = __pyx_t_13;

      /* "urh/cythonext/awre_util.pyx":37
 *     for i in range(0, len_bits1):
 *         for j in range(0, len_bits2):
 *             if seq1[i] == seq2[j]:             # <<<<<<<<<<<<<<
 *                 counter = m[i, j] + 1
 ...
 */
      ...
      __pyx_t_15 = (((*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5numpy_uint8_t *) __pyx_v_seq1.data) + __pyx_t_1)) ))) == (*((__pyx_t_5numpy_uint8_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5numpy_uint8_t *) __pyx_v_seq2.data) + __pyx_t_14)) )))) != 0);
      if (__pyx_t_15) {

        /* "urh/cythonext/awre_util.pyx":38
 *         for j in range(0, len_bits2):
 *             if seq1[i] == seq2[j]:
 *                 counter = m[i, j] + 1             # <<<<<<<<<<<<<<
 *                 m[i+1, j+1] = counter
 ...
 */
        ...
        __pyx_v_counter = ((*((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_m.data + __pyx_t_16 * __pyx_v_m.strides[0]) )) + __pyx_t_17)) ))) + 1);

        /* "urh/cythonext/awre_util.pyx":39
 *             if seq1[i] == seq2[j]:
 *                 counter = m[i, j] + 1
 *                 m[i+1, j+1] = counter             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_m.data + __pyx_t_18 * __pyx_v_m.strides[0]) )) + __pyx_t_19)) )) = __pyx_v_counter;
 ...
 * 
 */
        __pyx_t_15 = ((__pyx_v_counter > __pyx_v_longest) != 0);
        if (__pyx_t_15) {
 ...
 */
          __pyx_t_20 = __pyx_v_current_result;
          __pyx_t_21 = 0;
          *((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_indices.data + __pyx_t_20 * __pyx_v_result_indices.strides[0]) )) + __pyx_t_21)) )) = ((__pyx_v_i - __pyx_v_counter) + 1);
 ...
 */
          __pyx_t_22 = __pyx_v_current_result;
          __pyx_t_23 = 1;
          *((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_indices.data + __pyx_t_22 * __pyx_v_result_indices.strides[0]) )) + __pyx_t_23)) )) = (__pyx_v_i + 1);
 ...
 *                         result_indices[current_result, 0] = i - counter + 1
 */
          __pyx_t_15 = ((__pyx_v_current_result < (__pyx_v_max_results - 1)) != 0);
          if (__pyx_t_15) {
 ...
 * 
 */
            __pyx_t_24 = __pyx_v_current_result;
            __pyx_t_25 = 0;
            *((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_indices.data + __pyx_t_24 * __pyx_v_result_indices.strides[0]) )) + __pyx_t_25)) )) = ((__pyx_v_i - __pyx_v_counter) + 1);
 ...
 *     cdef set result = set()
 */
            __pyx_t_26 = __pyx_v_current_result;
            __pyx_t_27 = 1;
            *((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_indices.data + __pyx_t_26 * __pyx_v_result_indices.strides[0]) )) + __pyx_t_27)) )) = (__pyx_v_i + 1);
 ...
 * 
 */
  __pyx_t_28 = (__pyx_v_current_result + 1);
 ...
 */
    ...
    __pyx_t_31 = 0;
    __pyx_t_2 = __Pyx_PyInt_From_unsigned_int((*((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_indices.data + __pyx_t_30 * __pyx_v_result_indices.strides[0]) )) + __pyx_t_31)) )))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_32 = __pyx_v_i;
    __pyx_t_33 = 1;
    __pyx_t_4 = __Pyx_PyInt_From_unsigned_int((*((unsigned int *) ( /* dim=1 */ ((char *) (((unsigned int *) ( /* dim=0 */ (__pyx_v_result_indices.data + __pyx_t_32 * __pyx_v_result_indices.strides[0]) )) + __pyx_t_33)) )))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    ...
    __pyx_t_2 = 0;
    __pyx_t_4 = 0;
    __pyx_t_34 = PySet_Add(__pyx_v_result, __pyx_t_6); if (unlikely(__pyx_t_34 == ((int)-1))) __PYX_ERR(0, 55, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  }
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_result_indices, 1);
...
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_3find_longest_common_sub_sequence_indices(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("find_longest_common_sub_sequence_indices (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_seq2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("find_longest_common_sub_sequence_indices", 1, 2, 2, 1); __PYX_ERR(0, 28, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_longest_common_sub_sequence_indices") < 0)) __PYX_ERR(0, 28, __pyx_L3_error)
      }
    ...
    __pyx_v_seq1 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_uint8_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_seq1.memview)) __PYX_ERR(0, 28, __pyx_L3_error)
    __pyx_v_seq2 = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_seq2.memview)) __PYX_ERR(0, 28, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("find_longest_common_sub_sequence_indices", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 28, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("urh.cythonext.awre_util.find_longest_common_sub_sequence_indices", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
...
static PyObject *__pyx_pf_3urh_9cythonext_9awre_util_2find_longest_common_sub_sequence_indices(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_seq1, __Pyx_memviewslice __pyx_v_seq2) {
  ...
  __Pyx_RefNannySetupContext("find_longest_common_sub_sequence_indices", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_3urh_9cythonext_9awre_util_find_longest_common_sub_sequence_indices(__pyx_v_seq1, __pyx_v_seq2, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_5find_first_difference(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_3urh_9cythonext_9awre_util_find_first_difference(__Pyx_memviewslice __pyx_v_bits1, __Pyx_memviewslice __pyx_v_bits2, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
 ...
 */
    __pyx_t_7 = __pyx_v_i;
    __pyx_t_8 = __pyx_v_i;
    __pyx_t_9 = (((*((unsigned char *) ( /* dim=0 */ (__pyx_v_bits1.data + __pyx_t_7 * __pyx_v_bits1.strides[0]) ))) != (*((unsigned char *) ( /* dim=0 */ (__pyx_v_bits2.data + __pyx_t_8 * __pyx_v_bits2.strides[0]) )))) != 0);
    if (__pyx_t_9) {
...
/* Python wrapper */
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_5find_first_difference(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_5find_first_difference(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("find_first_difference (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bits1)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_bits2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("find_first_difference", 1, 2, 2, 1); __PYX_ERR(0, 59, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "find_first_difference") < 0)) __PYX_ERR(0, 59, __pyx_L3_error)
      }
    } else if (PyTuple_GET_SIZE(__pyx_args) != 2) {
      goto __pyx_L5_argtuple_error;
    } else {
    ...
    __pyx_v_bits1 = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_bits1.memview)) __PYX_ERR(0, 59, __pyx_L3_error)
    __pyx_v_bits2 = __Pyx_PyObject_to_MemoryviewSlice_ds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_bits2.memview)) __PYX_ERR(0, 59, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("find_first_difference", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 59, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("urh.cythonext.awre_util.find_first_difference", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_3urh_9cythonext_9awre_util_4find_first_difference(__pyx_self, __pyx_v_bits1, __pyx_v_bits2);
...
static PyObject *__pyx_pf_3urh_9cythonext_9awre_util_4find_first_difference(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_bits1, __Pyx_memviewslice __pyx_v_bits2) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("find_first_difference", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_3urh_9cythonext_9awre_util_find_first_difference(__pyx_v_bits1, __pyx_v_bits2, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 * 
 */
  __pyx_t_2 = ((__pyx_v_len_b > __pyx_v_len_a) != 0);
  if (__pyx_t_2) {

    /* "urh/cythonext/awre_util.pyx":81
 * 
 *     if len_b > len_a:
 *         return -1             # <<<<<<<<<<<<<<
 * 
...
static PyObject *__pyx_pw_3urh_9cythonext_9awre_util_7find_occurrences(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("find_occurrences (wrapper)", 0);
  {
    ...
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_uint8_t(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 69, __pyx_L3_error)
    __pyx_v_b = __Pyx_PyObject_to_MemoryviewSlice_dc_nn___pyx_t_5numpy_uint8_t(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_b.memview)) __PYX_ERR(0, 69, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "urh.cythonext.awre_util.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "urh.cythonext.awre_util.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "urh.cythonext.awre_util.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "urh.cythonext.awre_util._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  ...
  {"find_longest_common_sub_sequence_indices", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3urh_9cythonext_9awre_util_3find_longest_common_sub_sequence_indices, METH_VARARGS|METH_KEYWORDS, 0},
  {"find_first_difference", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3urh_9cythonext_9awre_util_5find_first_difference, METH_VARARGS|METH_KEYWORDS, 0},
  {"find_occurrences", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_3urh_9cythonext_9awre_util_7find_occurrences, METH_VARARGS|METH_KEYWORDS, __pyx_doc_3urh_9cythonext_9awre_util_6find_occurrences},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_awre_util(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_awre_util},
  {0, NULL}
};
#endif
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initawre_util(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initawre_util(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_awre_util(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_awre_util(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_awre_util(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'awre_util' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_awre_util(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("awre_util", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_urh__cythonext__awre_util) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "urh.cythonext.awre_util")) {
      if (unlikely(PyDict_SetItemString(modules, "urh.cythonext.awre_util", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init urh.cythonext.awre_util", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init urh.cythonext.awre_util");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
/* ObjectToMemviewSlice */
  static CYTHON_INLINE __Pyx_memviewslice __Pyx_PyObject_to_MemoryviewSlice_d_dc_unsigned_int(PyObject *obj, int writable_flag) {
    __Pyx_memviewslice result = { 0, 0, { 0 }, { 0 }, { 0 } };
    __Pyx_BufFmt_StackElem stack[1];
