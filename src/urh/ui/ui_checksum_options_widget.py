...
class Ui_ChecksumOptions(object):
    def setupUi(self, ChecksumOptions):
        ...
        ChecksumOptions.resize(558, 489)
        ...
        self.gridLayout_2.addWidget(self.label_crc_info, 4, 0, 1, 2)
        ...
        ChecksumOptions.setTabOrder(self.comboBoxCategory, self.comboBoxCRCFunction)
