...
class Ui_SendRecvDialog(object):
    def setupUi(self, SendRecvDialog):
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, -540, 392, 1111))
        ...
        self.gridLayout.addWidget(self.groupBox, 23, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_sniff_BitLength, 15, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_BitLen, 15, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.txtEditErrors, 24, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.label_sniff_Noise, 17, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_Noise, 17, 1, 1, 1)
        ...
        self.combox_sniff_Modulation.addItem("")
        self.combox_sniff_Modulation.addItem("")
        self.gridLayout.addWidget(self.combox_sniff_Modulation, 19, 1, 1, 1)
        ...
        self.comboBox_sniff_viewtype.addItem("")
        self.comboBox_sniff_viewtype.addItem("")
        self.gridLayout.addWidget(self.comboBox_sniff_viewtype, 20, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.spinbox_sniff_ErrorTolerance, 18, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_sniff_OutputFile, 22, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_sniff_encoding, 21, 1, 1, 1)
        ...
        self.graphicsView_sniff_Preview = LiveGraphicView(self.page)
