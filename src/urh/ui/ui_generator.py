...
"}")
        ...
        self.gridLayout_2.addWidget(self.tableBlocks, 2, 0, 1, 4)
        self.lEstimatedTime = QtWidgets.QLabel(self.layoutWidget1)
        self.lEstimatedTime.setObjectName("lEstimatedTime")
        self.gridLayout_2.addWidget(self.lEstimatedTime, 3, 0, 1, 1)
