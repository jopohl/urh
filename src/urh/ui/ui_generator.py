...
class Ui_GeneratorTab(object):
    def setupUi(self, GeneratorTab):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 588, 526))
        ...
        self.gridLayout.addWidget(self.tableMessages, 1, 0, 1, 5)
