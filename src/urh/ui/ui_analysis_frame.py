...
class Ui_FAnalysis(object):
    def setupUi(self, FAnalysis):
        ...
        FAnalysis.setProperty("lineWidth", 1)
        FAnalysis.setProperty("midLineWidth", 0)
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(FAnalysis)
...
"}")
        ...
        self.cbMessagetypes = QtWidgets.QComboBox(self.layoutWidget1)
        ...
        self.btnMessagetypeSettings = QtWidgets.QToolButton(self.layoutWidget1)
        ...
        self.btnAddMessagetype = QtWidgets.QToolButton(self.layoutWidget1)
        ...
        self.btnRemoveMessagetype = QtWidgets.QToolButton(self.layoutWidget1)
        ...
        self.tblLabelValues.horizontalHeader().setVisible(False)
