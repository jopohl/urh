...
class Ui_FuzzingDialog(object):
    def setupUi(self, FuzzingDialog):
        ...
        self.pageDeBruijnLabel = QtWidgets.QWidget()
        self.pageDeBruijnLabel.setObjectName("pageDeBruijnLabel")
        self.stackedWidgetLabels.addWidget(self.pageDeBruijnLabel)
        ...
        self.pageDeBruijn = QtWidgets.QWidget()
        self.pageDeBruijn.setObjectName("pageDeBruijn")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.pageDeBruijn)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.labelDeBruijn = QtWidgets.QLabel(self.pageDeBruijn)
        self.labelDeBruijn.setWordWrap(True)
        self.labelDeBruijn.setObjectName("labelDeBruijn")
        self.verticalLayout_8.addWidget(self.labelDeBruijn)
        self.stackedWidgetSpinboxes.addWidget(self.pageDeBruijn)
    ...
    def retranslateUi(self, FuzzingDialog):
        ...
        self.labelDeBruijn.setText(_translate("FuzzingDialog", "<html><head/><body><p>A nice text describing it.</p></body></html>"))
