...
class ProtocolTableView(TableView):
    ...
    def __init__(self, parent=None):
        ...
        self.ref_message_action.setShortcutContext(Qt.ShortcutContext.WidgetWithChildrenShortcut)
        ...
        self.hide_row_action.setShortcutContext(Qt.ShortcutContext.WidgetWithChildrenShortcut)
