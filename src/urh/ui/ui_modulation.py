...
class Ui_DialogModulation(object):
    def setupUi(self, DialogModulation):
        ...
        self.lEqual_qm.setMaximumSize(QtCore.QSize(30, 30))
        self.lEqual_qm.setText("")
        self.lEqual_qm.setPixmap(QtGui.QPixmap(":/icons/data/icons/equals_generator_qm.png"))
        ...
        self.gridLayout_7.addItem(spacerItem1, 7, 3, 1, 1)
        ...
        self.gridLayout_7.addItem(spacerItem3, 7, 1, 1, 1)
        ...
        self.gridLayout_7.addItem(spacerItem4, 4, 3, 1, 1)
        ...
        DialogModulation.setTabOrder(self.linEdDataBits, self.btnRestoreBits)
        DialogModulation.setTabOrder(self.btnRestoreBits, self.spinBoxBitLength)
